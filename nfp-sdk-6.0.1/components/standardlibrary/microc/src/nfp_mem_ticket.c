    ...
    )
{
    ...
    _INTRINSIC_BEGIN;
    {
        __asm
        {
            mem[write_atomic, dwr_ticket_line, 0, address, 4], sig_done[*sig_ptr]
        }
    }
    _INTRINSIC_END;
}
    ...
    )
{
    ...
    _INTRINSIC_BEGIN;
    {
        ...
        __asm
        {
            mem[write_atomic,dwr_ticket_line,hi_addr,<<8,low_addr,4], sig_done[*sig_ptr]
        }
    }
    _INTRINSIC_END;
}
