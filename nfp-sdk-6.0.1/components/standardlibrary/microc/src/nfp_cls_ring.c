...
void cls_ring_put_ptr32(
    ...
    unsigned int count,                                 /* number of longwords to put             */
...
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_put, 0, cls_ring_put, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_put, 0, cls_ring_put, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_journal, 0, cls_ring_journal, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_journal, 0, cls_ring_journal, 16);
    }
    _INTRINSIC_END;
}
...
void cls_ring_get_ptr32(
    ...
    volatile void __addr32 __cls *address,              /* ring address                           */
    unsigned int count,                                 /* number of longwords to get             */
    sync_t sync,                                        /* type of synchronization to use         */
    SIGNAL *sig_ptr                                     /* signal to raise upon completion        */
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_get, 1, cls_ring_get, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_get, 1, cls_ring_get, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_pop, 1, cls_ring_pop, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_pop, 1, cls_ring_pop, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_get_freely, 1, cls_ring_get_safe, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_get_freely, 1, cls_ring_get_safe, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND(ring_pop_freely, 1, cls_ring_pop_safe, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    _INTRINSIC_BEGIN;
    {
        ...
        _CLS_RING_IMPLEMENT_ADDRESS_COMMAND_PTR40(ring_pop_freely, 1, cls_ring_pop_safe, 16);
    }
    _INTRINSIC_END;
}
...
)
{
    ...
    _CLS_RING_BASE_ADDRESS_ALIGN_CHECK((unsigned int)base_address);

    {
        __addr32 __cls unsigned int            *ring_ptr_address = (__addr32 __cls unsigned int *)(RING_PTR_0 + (ring_number * 8));
        __addr32 __cls unsigned int            *ring_base_address = (__addr32 __cls unsigned int *)(RING_BASE_0 + (ring_number * 8));
        volatile __xwrite unsigned int      xfer;

        /* initialise ring base */
        {
            xfer = ((report_events & 0xf) << 24) | ( ((unsigned int)size & 0x07) << 16) | ((unsigned int)(base_address) >> 7) & 0x1ff;


            if (sync == sig_done)
            {
                cls_write_be_ptr32((void*)&xfer, ring_base_address, 1, sig_done, sig_ptr);
                __wait_for_all(sig_ptr);
            }
            else
            {
                cls_write_be_ptr32((void*)&xfer, ring_base_address, 1, ctx_swap, sig_ptr);
            }
        }
        ...
        /* clear ring pointers */
        {
            ...
            if (sync == sig_done)
            {
                cls_write_be_ptr32((void*)&xfer, ring_ptr_address, 1, sig_done, sig_ptr);
            }
            else
            {
                cls_write_be_ptr32((void*)&xfer, ring_ptr_address, 1, ctx_swap, sig_ptr);
            }
        }
    }
...
)
{
    ...
    {
        unsigned long long                              island = ((unsigned long long)base_address) & 0xFC00000000; // top 6 bits
        __addr40 __cls unsigned long long      *ring_ptr_address = (__addr40 __cls unsigned long long *)(island | RING_PTR_0 + (ring_number * 8));
        __addr40 __cls unsigned long long      *ring_base_address = (__addr40 __cls unsigned long long *)(island | RING_BASE_0 + (ring_number * 8));
        volatile __xwrite unsigned int     xfer;
        ...
        /* initialise ring base */
        {
            ...
            if (sync == sig_done)
            {
                cls_write_be_ptr40((void*)&xfer, ring_base_address, 1, sig_done, sig_ptr);
                __wait_for_all(sig_ptr);
            }
            else
            {
                cls_write_be_ptr40((void*)&xfer, ring_base_address, 1, ctx_swap, sig_ptr);
            }
        }
        ...
        /* clear ring pointers */
        {
            ...
            if (sync == sig_done)
            {
                cls_write_be_ptr40((void*)&xfer, ring_ptr_address, 1, sig_done, sig_ptr);
            }
            else
            {
                cls_write_be_ptr40((void*)&xfer, ring_ptr_address, 1, ctx_swap, sig_ptr);
            }
        }
    }
...
void cls_ring_write_ptr32(
    ...
    unsigned int ring_number,                           /* ring number                            */
    unsigned int count,                                 /* number of longwords to write           */
    unsigned int offset,                                /* offset to write at                     */
    sync_t sync,                                        /* type of synchronization to use         */
    SIGNAL *sig_ptr                                     /* signal to raise upon completion        */
)
{
...
void cls_ring_write_ptr40(
    ...
    unsigned int count,                                 /* number of longwords to write           */
    unsigned int offset,                                /* offset to write at                     */
    unsigned int island_id,                             /* CLS island where ring is located       */
    sync_t sync,                                        /* type of synchronization to use         */
    SIGNAL *sig_ptr                                     /* signal to raise upon completion        */
)
{
...
void cls_ring_put_ind_ptr40(
    ...
    unsigned int max_nn,                                /* max. number of longwords to put        */
...
void cls_ring_get_ind_ptr40(
    ...
    unsigned int max_nn,                                /* max. number of longwords to get        */
    generic_ind_t ind,                                  /* indirect word                          */
    sync_t sync,                                        /* type of synchronization to use         */
    SIGNAL *sig_ptr                                     /* signal to raise upon completion        */
    )
