...
#macro scratch_bits_test_and_clr(out_data, in_mask, in_scratch_addr, in_addr_offset, REQ_SIG, in_wakeup_sigs, Q_OPTION)
    ...
    _scratch_instr(test_and_clr, out_data, in_scratch_addr, in_addr_offset, dual_sig_op, REQ_SIG, in_wakeup_sigs, Q_OPTION)
#endm
...
#macro scratch_bits_test_and_set(out_data, in_mask, in_scratch_addr, in_addr_offset, REQ_SIG, in_wakeup_sigs, Q_OPTION)
    ...
    _scratch_instr(test_and_set, out_data, in_scratch_addr, in_addr_offset, dual_sig_op, REQ_SIG, in_wakeup_sigs, Q_OPTION)
#endm
