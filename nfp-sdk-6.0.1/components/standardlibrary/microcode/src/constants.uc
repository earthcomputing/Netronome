...
/// @cond INTERNAL_MACROS
     ...
     (defined(__NFP_INDIRECT_REF_FORMAT_NFP3200) || (!defined(__NFP_INDIRECT_REF_FORMAT_IXP) && !defined(__NFP_INDIRECT_REF_FORMAT_NFP6000))))
    #ifndef __NFP_INDIRECT_REF_FORMAT_NFP3200
        .indirect_ref_mode nfp_v1
        #define __NFP_INDIRECT_REF_FORMAT_NFP3200
    #endif
#elif (IS_NFPTYPE(__NFP6000) && \
     (defined(__NFP_INDIRECT_REF_FORMAT_NFP6000) || (!defined(__NFP_INDIRECT_REF_FORMAT_IXP) && !defined(__NFP_INDIRECT_REF_FORMAT_NFP3200))))
