...
.begin
    ...
    // Process in_qw_count
            ...
            #endif
            #if (defined(__NFP_INDIRECT_REF_FORMAT_NFP3200) || defined(__NFP_INDIRECT_FORMAT_NFP6000))
...
.begin
    ...
    #elif __NFP_INDIRECT_REF_FORMAT_NFP6000
...
#macro ddr_add64_immed_sat(indirect_ref_reg, val, addr, offset)
    _ddr_add64_immed_cmd(add64_imm_sat, indirect_ref_reg, val, addr, offset)
#endm
