...
#ifdef MASTERME
    volatile __declspec(i28.imem, shared, export) uint32_t fc_stats_lock_release = 0;
#else
    volatile __declspec(i28.imem, shared, import) uint32_t fc_stats_lock_release;
#endif
...
#endif
//         mem_incr32((__mem void *)&fc_stats_lock_release);
        return;
    }
