                         ...
                         uint32_t field_lkp_base_hi, int startbit)
{
    ...
    volatile __declspec(write_reg) unsigned int lookup_index[2];
                 ...
                 )
{
    ...
    __declspec(addr40) unsigned long *multilabel_addr;
                   ...
                   __xread struct dcfl_me_field_config *f_cfg)
{
    ...
    mem_read32(read_buf, (__addr40 uint32_t *)key + f_cfg->hdr_valid_offset,
                   sizeof(read_buf));
                     ...
                     __xread struct dcfl_me_field_config *f_cfg)
{
    ...
    /* Read 4 words from key */
    mem_read32(read_buf, (__addr40 uint32_t *)key + f_cfg->hdr_offset,
                   sizeof(read_buf));
