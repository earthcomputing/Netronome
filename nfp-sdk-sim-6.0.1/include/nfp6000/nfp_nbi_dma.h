...
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL0_BL_QUE_FULL    (1 << 39)
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL0_BL_QUE_EMPTY   (1 << 38)
...
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL1_BL_QUE_FULL    (1 << 39)
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL1_BL_QUE_EMPTY   (1 << 38)
...
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL2_BL_QUE_FULL    (1 << 39)
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL2_BL_QUE_EMPTY   (1 << 38)
...
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL3_BL_QUE_FULL    (1 << 39)
#define   NFP_NBI_DMA_BUFFERLIST_BL_QUE_CTRL3_BL_QUE_EMPTY   (1 << 38)
...
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BCRAM_ERR         (1 << 16)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BCRAM_ERR_ENABLE (0 << 16)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BCRAM_ERR_DISABLE (1 << 16)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_DSRAM_ERR         (1 << 15)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_DSRAM_ERR_ENABLE (0 << 15)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_DSRAM_ERR_DISABLE (1 << 15)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BDRAM_ERR         (1 << 14)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BDRAM_ERR_ENABLE (0 << 14)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BDRAM_ERR_DISABLE (1 << 14)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BUFRD_ERR         (1 << 13)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BUFRD_ERR_ENABLE (0 << 13)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_BUFRD_ERR_DISABLE (1 << 13)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXPUSH_LAST_ERR   (1 << 12)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXPUSH_LAST_ERR_ENABLE (0 << 12)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXPUSH_LAST_ERR_DISABLE (1 << 12)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXALLOC_IN_ERR    (1 << 11)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXALLOC_IN_ERR_ENABLE (0 << 11)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXALLOC_IN_ERR_DISABLE (1 << 11)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXBLQWR_IN_ERR    (1 << 10)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXBLQWR_IN_ERR_ENABLE (0 << 10)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_DIS_RXBLQWR_IN_ERR_DISABLE (1 << 10)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_NBI_NUM(_x)           (((_x) & 0x7) << 7)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_NBI_NUM_of(_x)        (((_x) >> 7) & 0x7)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_ENA          (1 << 6)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_ENA_DISABLE (0 << 6)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_ENA_ENABLE (1 << 6)
...
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_RATE_LIMIT_ENABLE     (1 << 1)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_RATE_LIMIT_ENABLE_DISABLE (0 << 1)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_RATE_LIMIT_ENABLE_ENABLE (1 << 1)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_SEARCH_ENA   (1 << 0)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_SEARCH_ENA_DISABLE (0 << 0)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_CFG_CTM_POLL_SEARCH_ENA_ENABLE (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_DMAX_CSR_NBI_DMA_BLQ_EVENT_DIS_BLQ_EVENT_FIFO_FULL_ASSERT (1 << 20)
...
#define   NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_DROP_EN            (1 << 13)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_DROP_EN_NODROP   (0 << 13)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_DROP_EN_DROP     (1 << 13)
#define   NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_CTM_OFFSET         (1 << 12)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_CTM_OFFSET_128   (0 << 12)
#define     NFP_NBI_DMAX_CSR_NBI_DMA_BP_CFG_CTM_OFFSET_64    (1 << 12)
...
#define   NFP_NBI_DMA_BufferList_BLQueCtrl0_BLQFull          (1 << 39)
#define   NFP_NBI_DMA_BufferList_BLQueCtrl0_BLQEmpty         (1 << 38)
...
#define   NFP_NBI_DMA_BufferList_BLQueCtrl1_BLQFull          (1 << 39)
#define   NFP_NBI_DMA_BufferList_BLQueCtrl1_BLQEmpty         (1 << 38)
...
#define   NFP_NBI_DMA_BufferList_BLQueCtrl2_BLQFull          (1 << 39)
#define   NFP_NBI_DMA_BufferList_BLQueCtrl2_BLQEmpty         (1 << 38)
...
#define   NFP_NBI_DMA_BufferList_BLQueCtrl3_BLQFull          (1 << 39)
#define   NFP_NBI_DMA_BufferList_BLQueCtrl3_BLQEmpty         (1 << 38)
...
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBcRamErr             (1 << 16)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBcRamErr_Enable    (0 << 16)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBcRamErr_Disable   (1 << 16)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisDsRamErr             (1 << 15)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisDsRamErr_Enable    (0 << 15)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisDsRamErr_Disable   (1 << 15)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBdRamErr             (1 << 14)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBdRamErr_Enable    (0 << 14)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBdRamErr_Disable   (1 << 14)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBufRdErr             (1 << 13)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBufRdErr_Enable    (0 << 13)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisBufRdErr_Disable   (1 << 13)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxPushLastErr        (1 << 12)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxPushLastErr_Enable (0 << 12)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxPushLastErr_Disable (1 << 12)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxAllocInErr         (1 << 11)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxAllocInErr_Enable (0 << 11)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxAllocInErr_Disable (1 << 11)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxBlqWrInErr         (1 << 10)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxBlqWrInErr_Enable (0 << 10)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_DisRxBlqWrInErr_Disable (1 << 10)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_NbiNum(_x)              (((_x) & 0x7) << 7)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_NbiNum_of(_x)           (((_x) >> 7) & 0x7)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollEna              (1 << 6)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollEna_Disable    (0 << 6)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollEna_Enable     (1 << 6)
...
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_RateLimitEnable         (1 << 1)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_RateLimitEnable_Disable (0 << 1)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_RateLimitEnable_Enable (1 << 1)
#define   NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollSearchEna        (1 << 0)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollSearchEna_Disable (0 << 0)
#define     NFP_NBI_DMAX_CSR_NbiDmaCfg_CtmPollSearchEna_Enable (1 << 0)
/*---------------------------------------------------------------- 
  Register: NbiDmaSpare - General Purpose Register
    Bits: 31:0  NbiDmaSpare(rw) - General use register.
*/
...
#define   NFP_NBI_DMAX_CSR_NbiDmaBlqEvent_DisBLQEventFifoFullAssert (1 << 20)
...
#define   NFP_NBI_DMAX_CSR_NbiDmaBPCfg_DropEn                (1 << 13)
#define     NFP_NBI_DMAX_CSR_NbiDmaBPCfg_DropEn_NoDrop       (0 << 13)
#define     NFP_NBI_DMAX_CSR_NbiDmaBPCfg_DropEn_Drop         (1 << 13)
#define   NFP_NBI_DMAX_CSR_NbiDmaBPCfg_CtmOffset             (1 << 12)
#define     NFP_NBI_DMAX_CSR_NbiDmaBPCfg_CtmOffset_128       (0 << 12)
#define     NFP_NBI_DMAX_CSR_NbiDmaBPCfg_CtmOffset_64        (1 << 12)
