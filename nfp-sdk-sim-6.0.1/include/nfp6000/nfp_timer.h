...
#ifndef NFP6000_TIMER_H
#define NFP6000_TIMER_H
...
*/
#define NFP_TIMER_CONTROL0                                   0x00000000
#define NFP_TIMER_CONTROL1                                   0x00000004
#define NFP_TIMER_CONTROL2                                   0x00000008
#define NFP_TIMER_CONTROL3                                   0x0000000c
#define   NFP_TIMER_TIMERCONTROL_ACTIVE                      (1 << 7)
#define   NFP_TIMER_TIMERCONTROL_PRESCALER(_x)               (((_x) & 0x3) << 2)
#define   NFP_TIMER_TIMERCONTROL_PRESCALER_of(_x)            (((_x) >> 2) & 0x3)
#define     NFP_TIMER_TIMERCONTROL_PRESCALER_PS1             (0)
#define     NFP_TIMER_TIMERCONTROL_PRESCALER_PS16            (1)
#define     NFP_TIMER_TIMERCONTROL_PRESCALER_PS256           (2)
#define     NFP_TIMER_TIMERCONTROL_PRESCALER_PSGPIO          (3)
/*---------------------------------------------------------------- 
...
*/
#define NFP_TIMER_LOADVALUE0                                 0x00000010
#define NFP_TIMER_LOADVALUE1                                 0x00000014
#define NFP_TIMER_LOADVALUE2                                 0x00000018
#define NFP_TIMER_LOADVALUE3                                 0x0000001c
#define   NFP_TIMER_TIMERCOUNTERLOADING_LOADVALUE(_x)        (((_x) & 0xffffffff) << 0)
#define   NFP_TIMER_TIMERCOUNTERLOADING_LOADVALUE_of(_x)     (((_x) >> 0) & 0xffffffff)
/*---------------------------------------------------------------- 
...
*/
#define NFP_TIMER_COUNTERVALUE0                              0x00000020
#define NFP_TIMER_COUNTERVALUE1                              0x00000024
#define NFP_TIMER_COUNTERVALUE2                              0x00000028
#define NFP_TIMER_COUNTERVALUE3                              0x0000002c
#define   NFP_TIMER_TIMERCOUNTERSTATUS_COUNTERVALUE(_x)      (((_x) & 0xffffffff) << 0)
#define   NFP_TIMER_TIMERCOUNTERSTATUS_COUNTERVALUE_of(_x)   (((_x) >> 0) & 0xffffffff)
/*---------------------------------------------------------------- 
...
*/
#define NFP_TIMER_INTERRUPTCLEAR0                            0x00000030
#define NFP_TIMER_INTERRUPTCLEAR1                            0x00000034
#define NFP_TIMER_INTERRUPTCLEAR2                            0x00000038
#define NFP_TIMER_INTERRUPTCLEAR3                            0x0000003c
#define   NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT                 (1 << 0)
#define     NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT_NOOP          (0 << 0)
#define     NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT_CI            (1 << 0)
/*---------------------------------------------------------------- 
...
*/
#define NFP_TIMER_WATCHDOGENABLE                             0x00000040
#define   NFP_TIMER_WATCHDOGENABLE_WDOGEN                    (1 << 0)
#define     NFP_TIMER_WATCHDOGENABLE_WDOGEN_NOOP             (0 << 0)
#define     NFP_TIMER_WATCHDOGENABLE_WDOGEN_CI               (1 << 0)
