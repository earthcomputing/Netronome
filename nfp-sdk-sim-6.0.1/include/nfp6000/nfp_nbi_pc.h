...
#define   NFP_NBI_PCX_PE_SETUP_HASHPREMULT                   (1 << 25)
#define   NFP_NBI_PCX_PE_SETUP_HASHSBOXEN                    (1 << 24)
...
#define   NFP_NBI_PCX_PE_SETUP_PKTPTROP                      (1 << 5)
#define   NFP_NBI_PCX_PE_SETUP_FETCH256                      (1 << 4)
...
#define   NFP_NBI_PCX_PE_RUNCONTROL_IGNRES                   (1 << 2)
...
#define   NFP_NBI_PCX_PE_TBLEXT_LOOKUPEXT                    (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_PCX_PE_CLASSSMALL_SATURATED                (1 << 31)
...
#define   NFP_NBI_PCX_PE_CLASSLARGE_SATURATED                (1 << 31)
...
#define   NFP_NBI_PCX_PE_CLASSSTUNN_SATURATED                (1 << 31)
...
#define   NFP_NBI_PCX_CHAR_CFG_EXTENDSKIP                    (1 << 27)
#define   NFP_NBI_PCX_CHAR_CFG_INNERDISABLE                  (1 << 26)
#define   NFP_NBI_PCX_CHAR_CFG_PPPDISABLE                    (1 << 25)
#define   NFP_NBI_PCX_CHAR_CFG_ETHDISABLE                    (1 << 24)
#define   NFP_NBI_PCX_CHAR_CFG_PPPADDSKP(_x)                 (((_x) & 0x3) << 20)
#define   NFP_NBI_PCX_CHAR_CFG_PPPADDSKP_of(_x)              (((_x) >> 20) & 0x3)
#define   NFP_NBI_PCX_CHAR_CFG_GFPCTLIGN                     (1 << 18)
#define   NFP_NBI_PCX_CHAR_CFG_GFPBARK                       (1 << 17)
#define   NFP_NBI_PCX_CHAR_CFG_GFPEXT                        (1 << 16)
#define   NFP_NBI_PCX_CHAR_CFG_PBBENABLE                     (1 << 11)
#define   NFP_NBI_PCX_CHAR_CFG_INITTAGEN                     (1 << 10)
...
*/
#define NFP_NBI_PCX_CHAR_TCAMTAGCTL0                         0x00000008
#define NFP_NBI_PCX_CHAR_TCAMTAGCTL1                         0x0000000c
...
#define   NFP_NBI_PCX_CHAR_TCAMTAGCTL_ENABLE                 (1 << 0)
/*---------------------------------------------------------------- 
...
*/
#define NFP_NBI_PCX_CHAR_TCAMTAG0                            0x00000010
#define NFP_NBI_PCX_CHAR_TCAMTAG1                            0x00000014
...
#define   NFP_NBI_PCX_CHAR_TABLESET_ONESHOT                  (1 << 31)
...
#define   NFP_NBI_PCX_CHAR_TABLESET_ACTIVE                   (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_PCX_CHAR_OVERRIDE_ONESHOT                  (1 << 1)
#define   NFP_NBI_PCX_CHAR_OVERRIDE_ENB                      (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_PCX_CHAR_TCAMMAPPING_OVERRIDE              (1 << 8)
...
#define   NFP_NBI_PCX_POL_ACC_SATURATE                       (1 << 31)
...
#define   NFP_NBI_PCX_POL_RATE_SHIFT                         (1 << 31)
...
#define   NFP_NBI_PCX_PE_PicoengineSetup_HashPremult         (1 << 25)
#define   NFP_NBI_PCX_PE_PicoengineSetup_HashSboxEnable      (1 << 24)
...
#define   NFP_NBI_PCX_PE_PicoengineSetup_PktPtrOp            (1 << 5)
#define   NFP_NBI_PCX_PE_PicoengineSetup_Fetch256            (1 << 4)
...
#define   NFP_NBI_PCX_PE_PicoengineRunControl_IgnoreResult   (1 << 2)
...
#define   NFP_NBI_PCX_PE_TableExtend_LookupExt               (1 << 0)
/*---------------------------------------------------------------- 
  Register: ActiveSet0Low - Bit-mask indicating which of the first 32 picoengines are actively classifying (i.e. neither ready with finished classification nor idle) using table set 0
  Register: ActiveSet1Low - Bit-mask indicating which of the first 32 picoengines are actively classifying (i.e. neither ready with finished classification nor idle) using table set 1
    Bits: 31:0  Status(ro) - One bit per picoengine indicating that the picoengine is actively classifying with a particular TableSet value; actively classifying means not idle and not presenting a result
...
#define   NFP_NBI_PCX_PE_ClassifiedSmall_Saturated           (1 << 31)
...
#define   NFP_NBI_PCX_PE_ClassifiedLarge_Saturated           (1 << 31)
...
#define   NFP_NBI_PCX_PE_Tunnel_Saturated                    (1 << 31)
...
#define   NFP_NBI_PCX_CHAR_Config_ExtendInitialSkip          (1 << 27)
#define   NFP_NBI_PCX_CHAR_Config_DisableInner               (1 << 26)
#define   NFP_NBI_PCX_CHAR_Config_DisablePPP                 (1 << 25)
#define   NFP_NBI_PCX_CHAR_Config_DisableEthernet            (1 << 24)
#define   NFP_NBI_PCX_CHAR_Config_PPPAddressSkip(_x)         (((_x) & 0x3) << 20)
#define   NFP_NBI_PCX_CHAR_Config_PPPAddressSkip_of(_x)      (((_x) >> 20) & 0x3)
#define   NFP_NBI_PCX_CHAR_Config_GFPControlIgn              (1 << 18)
#define   NFP_NBI_PCX_CHAR_Config_GFPBarker                  (1 << 17)
#define   NFP_NBI_PCX_CHAR_Config_GFPExtension               (1 << 16)
#define   NFP_NBI_PCX_CHAR_Config_PBBEnable                  (1 << 11)
#define   NFP_NBI_PCX_CHAR_Config_EnableInitialTag           (1 << 10)
...
/*---------------------------------------------------------------- 
  Register: TcamTagControl[2] - Configuration of Ethernet Tcam Tag X control
    ...
    Bits:  0    Enable(rw) - Set to enable use of the TCAM tag in Ethernet packets
*/
#define NFP_NBI_PCX_CHAR_TcamTagControl0                     0x00000008
#define NFP_NBI_PCX_CHAR_TcamTagControl1                     0x0000000c
...
#define   NFP_NBI_PCX_CHAR_TcamTagControl_Enable             (1 << 0)
/*---------------------------------------------------------------- 
  Register: TcamTag[2] - Configuration of Ethernet Tcam Tag X mask and match values
    Bits: 31:16 Mask(rw) - Mask for ANDing with 16-bit of Ethernet packet data
    Bits: 15:0  Value(rw) - Value to compare 16-bits of the Ethernet packet to after masking
...
#define NFP_NBI_PCX_CHAR_Override                            0x00000020
#define   NFP_NBI_PCX_CHAR_Override_OneShot                  (1 << 1)
#define   NFP_NBI_PCX_CHAR_Override_Enable                   (1 << 0)
/*---------------------------------------------------------------- 
  Register: OverridePort - Configuration of characterization override - internal use only
    Bits: 31:0  Port(wo) - Value to be used for the 'port' if characterization override is used for the picoengines
*/
...
#define   NFP_NBI_PCX_POL_Accumulator_Saturate               (1 << 31)
...
#define   NFP_NBI_PCX_POL_CreditRate_CreditShift             (1 << 31)
