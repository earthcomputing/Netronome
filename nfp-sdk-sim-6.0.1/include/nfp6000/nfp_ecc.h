...
#define   NFP_ECC_ENABLE_ALL                                 (1 << 0)
#define     NFP_ECC_ENABLE_ALL_DIS                           (0 << 0)
#define     NFP_ECC_ENABLE_ALL_EN                            (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ECC_ECCERROR_VALID                             (1 << 31)
#define     NFP_ECC_ECCERROR_VALID_NOERRS                    (0 << 31)
#define     NFP_ECC_ECCERROR_VALID_ERRS                      (1 << 31)
#define   NFP_ECC_ECCERROR_MULTIBIT                          (1 << 25)
#define   NFP_ECC_ECCERROR_SINGLEBIT                         (1 << 24)
...
#define     NFP_ECC_ECCEnable_Enable_EN                      (1 << 0)
/*---------------------------------------------------------------- 
  Register: InjectClear - Clear any outstanding ECC error injection
*/
...
#define     NFP_ECC_ECCError_Valid_NOERRS                    (0 << 31)
#define     NFP_ECC_ECCError_Valid_ERRS                      (1 << 31)
#define   NFP_ECC_ECCError_MultibitError                     (1 << 25)
#define   NFP_ECC_ECCError_SinglebitError                    (1 << 24)
