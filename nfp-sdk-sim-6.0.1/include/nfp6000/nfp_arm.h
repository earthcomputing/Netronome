...
#define   NFP_ARM_GCSR_BULKBARCFG_TYPE                       (1 << 31)
#define     NFP_ARM_GCSR_BULKBARCFG_TYPE_BULK                (0 << 31)
#define     NFP_ARM_GCSR_BULKBARCFG_TYPE_EXPA                (1 << 31)
...
#define   NFP_ARM_GCSR_BULKBARCFG_LEN                        (1 << 24)
#define     NFP_ARM_GCSR_BULKBARCFG_LEN_32BIT                (0 << 24)
#define     NFP_ARM_GCSR_BULKBARCFG_LEN_64BIT                (1 << 24)
...
#define   NFP_ARM_GCSR_EXPANSIONBARCFG_TYPE                  (1 << 31)
#define     NFP_ARM_GCSR_EXPANSIONBARCFG_TYPE_EXPA           (0 << 31)
#define     NFP_ARM_GCSR_EXPANSIONBARCFG_TYPE_EXPL           (1 << 31)
...
#define   NFP_ARM_GCSR_EXPANSIONBARCFG_LEN                   (1 << 24)
#define     NFP_ARM_GCSR_EXPANSIONBARCFG_LEN_32BIT           (0 << 24)
#define     NFP_ARM_GCSR_EXPANSIONBARCFG_LEN_64BIT           (1 << 24)
...
#define   NFP_ARM_GCSR_EXPL1_BAR_POSTED                      (1 << 31)
...
#define   NFP_ARM_GCSR_EXPL_POST_SIG_B_BUS                   (1 << 24)
#define     NFP_ARM_GCSR_EXPL_POST_SIG_B_BUS_PULL            (0 << 24)
#define     NFP_ARM_GCSR_EXPL_POST_SIG_B_BUS_PUSH            (1 << 24)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_A(_x)                   (((_x) & 0x7f) << 17)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_A_of(_x)                (((_x) >> 17) & 0x7f)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_A_BUS                   (1 << 16)
#define     NFP_ARM_GCSR_EXPL_POST_SIG_A_BUS_PULL            (0 << 16)
#define     NFP_ARM_GCSR_EXPL_POST_SIG_A_BUS_PUSH            (1 << 16)
#define   NFP_ARM_GCSR_EXPL_POST_NOSPLIT_RCVD_B              (1 << 11)
#define   NFP_ARM_GCSR_EXPL_POST_NOSPLIT_ENABLE_B            (1 << 10)
#define   NFP_ARM_GCSR_EXPL_POST_NOSPLIT_RCVD_A              (1 << 9)
#define   NFP_ARM_GCSR_EXPL_POST_NOSPLIT_ENABLE_A            (1 << 8)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_B_RCVD                  (1 << 7)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_B_VALID                 (1 << 6)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_A_RCVD                  (1 << 5)
#define   NFP_ARM_GCSR_EXPL_POST_SIG_A_VALID                 (1 << 4)
#define   NFP_ARM_GCSR_EXPL_POST_CMD_COMPLETE                (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ARM_GCSR_MPCORECFG_PL310CFGBIGEND              (1 << 25)
...
#define   NFP_ARM_GCSR_MPCORECFG_RESET_VECTOR                (1 << 8)
#define     NFP_ARM_GCSR_MPCORECFG_RESET_VECTOR_LO           (0 << 8)
#define     NFP_ARM_GCSR_MPCORECFG_RESET_VECTOR_HI           (1 << 8)
...
#define   NFP_ARM_GCSR_DFT_DBG_REQ                           (1 << 20)
#define   NFP_ARM_GCSR_DFT_DBG_EN                            (1 << 19)
#define   NFP_ARM_GCSR_DFT_WFE_EVT_TRG                       (1 << 18)
#define   NFP_ARM_GCSR_DFT_ETM_WFI_RDY                       (1 << 17)
#define   NFP_ARM_GCSR_DFT_ETM_PWR_ON                        (1 << 16)
...
#define   NFP_ARM_GCSR_ARMSTATUS_COMMRX_CPU0                 (1 << 7)
#define   NFP_ARM_GCSR_ARMSTATUS_COMMTX_CPU0                 (1 << 6)
#define   NFP_ARM_GCSR_ARMSTATUS_SMPNAMP                     (1 << 5)
#define   NFP_ARM_GCSR_ARMSTATUS_PWRCTL0(_x)                 (((_x) & 0x3) << 3)
#define   NFP_ARM_GCSR_ARMSTATUS_PWRCTL0_of(_x)              (((_x) >> 3) & 0x3)
#define   NFP_ARM_GCSR_ARMSTATUS_WFE                         (1 << 2)
#define   NFP_ARM_GCSR_ARMSTATUS_WFI                         (1 << 1)
#define   NFP_ARM_GCSR_ARMSTATUS_L2_IDLE                     (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ARM_GCSR_CFGCONFIGSTS_CFGCOMPLETED             (1 << 8)
...
#define   NFP_ARM_GCSR_CFGCONFIGSTS_CFGSUCCESS               (1 << 1)
#define   NFP_ARM_GCSR_CFGCONFIGSTS_CFGIMAGE                 (1 << 0)
/*---------------------------------------------------------------- 
...
#define NFP_ARM_GCSR_BulkBar0Boot                            0x0000015c
#define   NFP_ARM_GCSR_BulkBarCfg_BarType                    (1 << 31)
#define     NFP_ARM_GCSR_BulkBarCfg_BarType_BULK             (0 << 31)
#define     NFP_ARM_GCSR_BulkBarCfg_BarType_EXPA             (1 << 31)
...
#define   NFP_ARM_GCSR_BulkBarCfg_Length                     (1 << 24)
#define     NFP_ARM_GCSR_BulkBarCfg_Length_32BIT             (0 << 24)
#define     NFP_ARM_GCSR_BulkBarCfg_Length_64BIT             (1 << 24)
...
#define NFP_ARM_GCSR_ExpansionBar0Boot                       0x00000160
#define   NFP_ARM_GCSR_ExpansionBarCfg_BarType               (1 << 31)
#define     NFP_ARM_GCSR_ExpansionBarCfg_BarType_EXPA        (0 << 31)
#define     NFP_ARM_GCSR_ExpansionBarCfg_BarType_EXPL        (1 << 31)
...
#define   NFP_ARM_GCSR_ExpansionBarCfg_Length                (1 << 24)
#define     NFP_ARM_GCSR_ExpansionBarCfg_Length_32BIT        (0 << 24)
#define     NFP_ARM_GCSR_ExpansionBarCfg_Length_64BIT        (1 << 24)
...
#define   NFP_ARM_GCSR_ExplicitBarCfg1_Posted                (1 << 31)
...
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalBBus        (1 << 24)
#define     NFP_ARM_GCSR_PostedCommandSignal_SignalBBus_PULL (0 << 24)
#define     NFP_ARM_GCSR_PostedCommandSignal_SignalBBus_PUSH (1 << 24)
...
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalABus        (1 << 16)
#define     NFP_ARM_GCSR_PostedCommandSignal_SignalABus_PULL (0 << 16)
#define     NFP_ARM_GCSR_PostedCommandSignal_SignalABus_PUSH (1 << 16)
#define   NFP_ARM_GCSR_PostedCommandSignal_NosplitReceivedB  (1 << 11)
#define   NFP_ARM_GCSR_PostedCommandSignal_NosplitEnableB    (1 << 10)
#define   NFP_ARM_GCSR_PostedCommandSignal_NosplitReceivedA  (1 << 9)
#define   NFP_ARM_GCSR_PostedCommandSignal_NosplitEnableA    (1 << 8)
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalBReceived   (1 << 7)
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalBValid      (1 << 6)
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalAReceived   (1 << 5)
#define   NFP_ARM_GCSR_PostedCommandSignal_SignalAValid      (1 << 4)
#define   NFP_ARM_GCSR_PostedCommandSignal_CmdComplete       (1 << 0)
/*---------------------------------------------------------------- 
  Register: MPCoreBaseAddress - MPCore Base Address
    Bits: 31:13 BaseAddress(rw) - Base address for CSRs in MPCore
*/
...
#define   NFP_ARM_GCSR_MPCoreCfg_PL310_Cfg_Bigend            (1 << 25)
...
#define   NFP_ARM_GCSR_MPCoreCfg_MP0RstVecLoc                (1 << 8)
#define     NFP_ARM_GCSR_MPCoreCfg_MP0RstVecLoc_LO           (0 << 8)
#define     NFP_ARM_GCSR_MPCoreCfg_MP0RstVecLoc_HI           (1 << 8)
...
#define   NFP_ARM_GCSR_ArmDft_DbgReq                         (1 << 20)
#define   NFP_ARM_GCSR_ArmDft_DbgEn                          (1 << 19)
#define   NFP_ARM_GCSR_ArmDft_WfeEvtTrg                      (1 << 18)
#define   NFP_ARM_GCSR_ArmDft_EtmWfiReady                    (1 << 17)
#define   NFP_ARM_GCSR_ArmDft_EtmPowerOn                     (1 << 16)
