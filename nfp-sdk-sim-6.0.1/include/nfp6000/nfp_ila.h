...
#define   NFP_ILA_ERROR_CODE_ILA_ERROR_CODE_ILA_ERRORCODE_GEN (1 << 1)
#define   NFP_ILA_ERROR_CODE_ILA_ERROR_CODE_ILA_ERRORCODE_CHAN (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILA_BARCFG_I2C_LEN                             (1 << 22)
#define     NFP_ILA_BARCFG_I2C_LEN_32BIT                     (0 << 22)
#define     NFP_ILA_BARCFG_I2C_LEN_64BIT                     (1 << 22)
/*---------------------------------------------------------------- 
...
#define   NFP_ILA_BARCFG_C2I_ILA_CH_SEL                      (1 << 21)
...
#define   NFP_ILA_DMA_ILADMACOMMAND_SIGNAL_BOTH_ON_ERR_EN    (1 << 45)
#define     NFP_ILA_DMA_ILADMACOMMAND_SIGNAL_BOTH_ON_ERR_EN_DONT_ASSERT_NO_SPLIT (0 << 45)
#define     NFP_ILA_DMA_ILADMACOMMAND_SIGNAL_BOTH_ON_ERR_EN_ASSERT_NO_SPLIT (1 << 45)
#define   NFP_ILA_DMA_ILADMACOMMAND_TARGET64                 (1 << 44)
#define     NFP_ILA_DMA_ILADMACOMMAND_TARGET64_DISABLE       (0 << 44)
#define     NFP_ILA_DMA_ILADMACOMMAND_TARGET64_ENABLE        (1 << 44)
...
#define   NFP_ILA_DMA_ILADMACONTROL_DESC_ERROR               (1 << 5)
#define     NFP_ILA_DMA_ILADMACONTROL_DESC_ERROR_NO_EFFECT   (0 << 5)
#define     NFP_ILA_DMA_ILADMACONTROL_DESC_ERROR_CLEAR       (1 << 5)
#define   NFP_ILA_DMA_ILADMACONTROL_ILA_ERROR                (1 << 4)
#define     NFP_ILA_DMA_ILADMACONTROL_ILA_ERROR_NO_EFFECT    (0 << 4)
#define     NFP_ILA_DMA_ILADMACONTROL_ILA_ERROR_CLEAR        (1 << 4)
#define   NFP_ILA_DMA_ILADMACONTROL_QUEUE_OVERFLOW           (1 << 2)
#define     NFP_ILA_DMA_ILADMACONTROL_QUEUE_OVERFLOW_NO_EFFECT (0 << 2)
#define     NFP_ILA_DMA_ILADMACONTROL_QUEUE_OVERFLOW_CLEAR   (1 << 2)
#define   NFP_ILA_DMA_ILADMACONTROL_CONT_ON_ERROR            (1 << 1)
#define     NFP_ILA_DMA_ILADMACONTROL_CONT_ON_ERROR_DISABLE  (0 << 1)
#define     NFP_ILA_DMA_ILADMACONTROL_CONT_ON_ERROR_ENABLE   (1 << 1)
#define   NFP_ILA_DMA_ILADMACONTROL_QUEUE_STOP               (1 << 0)
#define     NFP_ILA_DMA_ILADMACONTROL_QUEUE_STOP_DISABLE     (0 << 0)
#define     NFP_ILA_DMA_ILADMACONTROL_QUEUE_STOP_ENABLE      (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_QUEUE_FULL           (1 << 7)
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_DESC_ERROR           (1 << 5)
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_ILA_ERROR            (1 << 4)
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_QUEUE_OVERFLOW       (1 << 2)
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_CONT_ON_ERROR        (1 << 1)
#define   NFP_ILA_DMA_ILADMAQUEUESTATUS_QUEUE_STOP           (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILA_TCAM_CMD_TILA_TCAM_TARGET64_RET            (1 << 110)
...
#define   NFP_ILA_TCAM_CMD_TILA_TCAM_SIGNAL_BOTH_ON_ERR_EN   (1 << 45)
#define     NFP_ILA_TCAM_CMD_TILA_TCAM_SIGNAL_BOTH_ON_ERR_EN_DONT_ASSERT_NO_SPLIT (0 << 45)
#define     NFP_ILA_TCAM_CMD_TILA_TCAM_SIGNAL_BOTH_ON_ERR_EN_ASSERT_NO_SPLIT (1 << 45)
#define   NFP_ILA_TCAM_CMD_TILA_TCAM_TARGET64                (1 << 44)
#define     NFP_ILA_TCAM_CMD_TILA_TCAM_TARGET64_DISABLE      (0 << 44)
#define     NFP_ILA_TCAM_CMD_TILA_TCAM_TARGET64_ENABLE       (1 << 44)
...
#define   NFP_ILA_TCAM_CTRL_TILA_TCAM_DESC_ERROR             (1 << 5)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_DESC_ERROR_NO_EFFECT (0 << 5)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_DESC_ERROR_CLEAR     (1 << 5)
#define   NFP_ILA_TCAM_CTRL_TILA_TCAM_ILA_ERROR              (1 << 4)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_ILA_ERROR_NO_EFFECT  (0 << 4)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_ILA_ERROR_CLEAR      (1 << 4)
#define   NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_OVERFLOW         (1 << 2)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_OVERFLOW_NO_EFFECT (0 << 2)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_OVERFLOW_CLEAR (1 << 2)
#define   NFP_ILA_TCAM_CTRL_TILA_TCAM_CONT_ON_ERROR          (1 << 1)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_CONT_ON_ERROR_DISABLE (0 << 1)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_CONT_ON_ERROR_ENABLE (1 << 1)
#define   NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_STOP             (1 << 0)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_STOP_DISABLE   (0 << 0)
#define     NFP_ILA_TCAM_CTRL_TILA_TCAM_QUEUE_STOP_ENABLE    (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_QUEUE_FULL             (1 << 7)
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_DESC_ERROR             (1 << 5)
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_ILA_ERROR              (1 << 4)
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_QUEUE_OVERFLOW         (1 << 2)
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_CONT_ON_ERROR          (1 << 1)
#define   NFP_ILA_TCAM_QSTS_TILA_TCAM_QUEUE_STOP             (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_PACK              (1 << 20)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_PACK_ILARXFIFOPACKENA (0 << 20)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_PACK_ILARXFIFOPACKDIS (1 << 20)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_TX_IDLE_CNT(_x)           (((_x) & 0x3ff) << 10)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_TX_IDLE_CNT_of(_x)        (((_x) >> 10) & 0x3ff)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_SIZE              (1 << 9)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_SIZE_ILARXFIFO4K (0 << 9)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_RX_FIFO_SIZE_ILARXFIFO8K (1 << 9)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_TX_WR_CREDIT_CNT_ENA      (1 << 8)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_TX_WR_CREDIT_CNT_ENA_DIS (0 << 8)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_TX_WR_CREDIT_CNT_ENA_ENA (1 << 8)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_ERR_POISON_EN             (1 << 5)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_ERR_POISON_EN_DISABLE   (0 << 5)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_ERR_POISON_EN_ENABLE    (1 << 5)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_CTRL_RSVD2                (1 << 4)
#define   NFP_ILAX_CSR_ILA_CFG_BURST_MAX                     (1 << 3)
#define     NFP_ILAX_CSR_ILA_CFG_BURST_MAX_256               (0 << 3)
#define     NFP_ILAX_CSR_ILA_CFG_BURST_MAX_512               (1 << 3)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_CTRL_RSVD                 (1 << 2)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_MODE                      (1 << 1)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_MODE_TCAM               (0 << 1)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_MODE_ACCEL              (1 << 1)
#define   NFP_ILAX_CSR_ILA_CFG_ILA_CPP_ADDR_MODE             (1 << 0)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_CPP_ADDR_MODE_40        (0 << 0)
#define     NFP_ILAX_CSR_ILA_CFG_ILA_CPP_ADDR_MODE_32        (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILAX_CSR_ILA_ERR_STAT_INVALID_TAG              (1 << 13)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_RX_ERR_ALL               (1 << 12)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_CPPT_BAD_CMB             (1 << 11)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_TGT_WR_START_ERR         (1 << 10)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_CPP_TC_PULL_ERR          (1 << 9)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_CPP_TC_PUSH_ERR          (1 << 8)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_TGT_WR_END_ERR           (1 << 7)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_RX_ERR                   (1 << 6)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_EOP_ERR                  (1 << 5)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_TIME_OUT_ERR             (1 << 1)
#define   NFP_ILAX_CSR_ILA_ERR_STAT_ILA_RX_ALIGN_ERR         (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILAX_CSR_ILA_ERR_MASK_INVALID_TAG_MASK         (1 << 13)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_RX_ERR_ALL_MASK          (1 << 12)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_CPPT_BAD_CMB_MASK        (1 << 11)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_TGT_WR_START_ERR_MASK    (1 << 10)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_CPP_TC_PULL_ERR_MASK     (1 << 9)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_CPP_TC_PUSH_ERR_MASK     (1 << 8)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_TGT_WR_END_ERR_MASK      (1 << 7)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_RX_ERR_MASK              (1 << 6)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_EOP_ERR_MASK             (1 << 5)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_TIME_OUT_ERR_MASK        (1 << 1)
#define   NFP_ILAX_CSR_ILA_ERR_MASK_ILA_RX_ALIGN_ERR_MASK    (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ILAX_CSR_ILASRAMCTRL_BC2_0                     (1 << 14)
#define   NFP_ILAX_CSR_ILASRAMCTRL_BC1_0                     (1 << 13)
#define   NFP_ILAX_CSR_ILASRAMCTRL_TEST1B_0                  (1 << 12)
#define   NFP_ILAX_CSR_ILASRAMCTRL_TEST_TEST1A_0             (1 << 11)
#define   NFP_ILAX_CSR_ILASRAMCTRL_RA_RM_OVRD_0              (1 << 10)
...
#define   NFP_ILAX_CSR_ILA_TXERR_CTRL_ILA_TX_ERR_DISABLE     (1 << 0)
...
#define   NFP_ILA_ERROR_CODE_IlaErrorCode_IlaErrorCodeGen    (1 << 1)
#define   NFP_ILA_ERROR_CODE_IlaErrorCode_IlaErrorCodeChan   (1 << 0)
/*---------------------------------------------------------------- 
  Register: IlaToCppBar[8] - ILA to CPP translation BAR
    Bits: 29:25 TargetID(rw) - CPP target ID. Local Registers are accessed when TargetID=0
    Bits: 24:23 Token(rw) - CPP token field.
...
#define   NFP_ILA_BARCFG_IlaToCppBar_LengthSelect            (1 << 22)
#define     NFP_ILA_BARCFG_IlaToCppBar_LengthSelect_32BIT    (0 << 22)
#define     NFP_ILA_BARCFG_IlaToCppBar_LengthSelect_64BIT    (1 << 22)
/*---------------------------------------------------------------- 
  Register: CppToIlaBar[8] - CPP to ILA translation BAR
    Bits: 21    IlaChSel(rw) - Selects which ILA Channel to send the command on
    Bits: 20:0  Address(rw) - In 32-bit mode: ILA address bits [47:27]; In 40-bit mode: ILA address bits[47:35]
...
#define   NFP_ILA_BARCFG_CppToIlaBar_IlaChSel                (1 << 21)
...
#define   NFP_ILA_DMA_IlaDmaCommand_Token(_x)                (((_x) & 0x3) << 46)
#define   NFP_ILA_DMA_IlaDmaCommand_Token_of(_x)             (((_x) >> 46) & 0x3)
#define   NFP_ILA_DMA_IlaDmaCommand_SignalBothOnErrEn        (1 << 45)
#define     NFP_ILA_DMA_IlaDmaCommand_SignalBothOnErrEn_Dont_assert_no_split (0 << 45)
#define     NFP_ILA_DMA_IlaDmaCommand_SignalBothOnErrEn_Assert_no_split (1 << 45)
#define   NFP_ILA_DMA_IlaDmaCommand_Target64                 (1 << 44)
#define     NFP_ILA_DMA_IlaDmaCommand_Target64_DISABLE       (0 << 44)
#define     NFP_ILA_DMA_IlaDmaCommand_Target64_ENABLE        (1 << 44)
...
#define   NFP_ILA_DMA_IlaDmaControl_DescReadError            (1 << 5)
#define     NFP_ILA_DMA_IlaDmaControl_DescReadError_No_Effect (0 << 5)
#define     NFP_ILA_DMA_IlaDmaControl_DescReadError_CLEAR    (1 << 5)
#define   NFP_ILA_DMA_IlaDmaControl_IlaError                 (1 << 4)
#define     NFP_ILA_DMA_IlaDmaControl_IlaError_No_Effect     (0 << 4)
#define     NFP_ILA_DMA_IlaDmaControl_IlaError_CLEAR         (1 << 4)
#define   NFP_ILA_DMA_IlaDmaControl_QueueOverflow            (1 << 2)
#define     NFP_ILA_DMA_IlaDmaControl_QueueOverflow_No_Effect (0 << 2)
#define     NFP_ILA_DMA_IlaDmaControl_QueueOverflow_CLEAR    (1 << 2)
#define   NFP_ILA_DMA_IlaDmaControl_ContinueOnError          (1 << 1)
#define     NFP_ILA_DMA_IlaDmaControl_ContinueOnError_DISABLE (0 << 1)
#define     NFP_ILA_DMA_IlaDmaControl_ContinueOnError_ENABLE (1 << 1)
#define   NFP_ILA_DMA_IlaDmaControl_QueueStop                (1 << 0)
#define     NFP_ILA_DMA_IlaDmaControl_QueueStop_DISABLE      (0 << 0)
#define     NFP_ILA_DMA_IlaDmaControl_QueueStop_ENABLE       (1 << 0)
/*---------------------------------------------------------------- 
  Register: DmaWritePtrCh0ToIla - Write pointer for Ch0ToIla DMA command queue
  Register: DmaWritePtrCh1ToIla - Write pointer for Ch1ToIla DMA command queue
    Bits: 23:16 CmplFifoPopPtr(ro) - Number of entries popped from the Completion FIFO.
...
#define   NFP_ILA_DMA_IlaDmaQueueStatus_QueueFull            (1 << 7)
#define   NFP_ILA_DMA_IlaDmaQueueStatus_DescReadError        (1 << 5)
#define   NFP_ILA_DMA_IlaDmaQueueStatus_IlaError             (1 << 4)
#define   NFP_ILA_DMA_IlaDmaQueueStatus_QueueOverflow        (1 << 2)
#define   NFP_ILA_DMA_IlaDmaQueueStatus_ContinueOnError      (1 << 1)
#define   NFP_ILA_DMA_IlaDmaQueueStatus_QueueStop            (1 << 0)
/*---------------------------------------------------------------- 
  Register: DmaCommandToIlaTcam - Insert command into ToIla TCAM DMA command queue
    Bits: 127:116 XferLength(wo) - Length of transfer in bytes
    Bits: 110    Target64Ret(wo) - CPP target is 64-bit for return transaction. Set if target supports 64-bit transactions, or cleared if target only supports 32-bit transaction.
...
#define   NFP_ILA_TCAM_DmaCommandToIlaTcam_Target64Ret       (1 << 110)
...
#define   NFP_ILA_TCAM_DmaCommandToIlaTcam_SignalBothOnErrEn (1 << 45)
#define     NFP_ILA_TCAM_DmaCommandToIlaTcam_SignalBothOnErrEn_Dont_assert_no_split (0 << 45)
#define     NFP_ILA_TCAM_DmaCommandToIlaTcam_SignalBothOnErrEn_Assert_no_split (1 << 45)
#define   NFP_ILA_TCAM_DmaCommandToIlaTcam_Target64          (1 << 44)
#define     NFP_ILA_TCAM_DmaCommandToIlaTcam_Target64_DISABLE (0 << 44)
#define     NFP_ILA_TCAM_DmaCommandToIlaTcam_Target64_ENABLE (1 << 44)
...
#define   NFP_ILA_TCAM_DmaCtrlToIlaTcam_DescReadError        (1 << 5)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_DescReadError_No_Effect (0 << 5)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_DescReadError_CLEAR (1 << 5)
#define   NFP_ILA_TCAM_DmaCtrlToIlaTcam_IlaError             (1 << 4)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_IlaError_No_Effect (0 << 4)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_IlaError_CLEAR     (1 << 4)
#define   NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueOverflow        (1 << 2)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueOverflow_No_Effect (0 << 2)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueOverflow_CLEAR (1 << 2)
#define   NFP_ILA_TCAM_DmaCtrlToIlaTcam_ContinueOnError      (1 << 1)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_ContinueOnError_DISABLE (0 << 1)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_ContinueOnError_ENABLE (1 << 1)
#define   NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueStop            (1 << 0)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueStop_DISABLE  (0 << 0)
#define     NFP_ILA_TCAM_DmaCtrlToIlaTcam_QueueStop_ENABLE   (1 << 0)
/*---------------------------------------------------------------- 
  Register: DmaWritePtrToIlaTcam - Write pointer for ToIla TCAM DMA command queue
    Bits: 23:16 CmplFifoPopPtr(ro) - Number of entries popped from the Completion FIFO.
    Bits:  8:0  Pointer(ro) - Write pointer address in queue memory
...
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_QueueFull         (1 << 7)
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_DescReadError     (1 << 5)
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_IlaError          (1 << 4)
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_QueueOverflow     (1 << 2)
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_ContinueOnError   (1 << 1)
#define   NFP_ILA_TCAM_DmaQStatusToIlaTcam_QueueStop         (1 << 0)
/*---------------------------------------------------------------- 
  Register: IlaCtrlCfg - Selects operation mode for the ILA controller
    Bits: 20    IlaRxFifoPack(rw) - ILA RX FIFO PACKING
    Bits: 19:10 IlaTxIdleCnt(rw) - Controls how often idle packets are transmitted. Idle packets communicate the LCC value to the peer device when no active packets are being transmitted. Software must program this value AFTER changing the IlaMode=ACCEL. The recommended value is 15.
...
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoPack              (1 << 20)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoPack_ILARXFIFOPACKENA (0 << 20)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoPack_ILARXFIFOPACKDIS (1 << 20)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaTxIdleCnt(_x)           (((_x) & 0x3ff) << 10)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaTxIdleCnt_of(_x)        (((_x) >> 10) & 0x3ff)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoSize              (1 << 9)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoSize_ILARXFIFO4k (0 << 9)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaRxFifoSize_ILARXFIFO8K (1 << 9)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaTxWrCreditCntEna        (1 << 8)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaTxWrCreditCntEna_DIS  (0 << 8)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaTxWrCreditCntEna_ENA  (1 << 8)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaErrPoisonEn             (1 << 5)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaErrPoisonEn_Disable   (0 << 5)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaErrPoisonEn_Enable    (1 << 5)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaCtrlRsvd2               (1 << 4)
#define   NFP_ILAX_CSR_IlaCtrlCfg_BurstMax                   (1 << 3)
#define     NFP_ILAX_CSR_IlaCtrlCfg_BurstMax_256             (0 << 3)
#define     NFP_ILAX_CSR_IlaCtrlCfg_BurstMax_512             (1 << 3)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaCtrlRsvd                (1 << 2)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaMode                    (1 << 1)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaMode_TCAM             (0 << 1)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaMode_ACCEL            (1 << 1)
#define   NFP_ILAX_CSR_IlaCtrlCfg_IlaCppAddrMode             (1 << 0)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaCppAddrMode_40        (0 << 0)
#define     NFP_ILAX_CSR_IlaCtrlCfg_IlaCppAddrMode_32        (1 << 0)
/*---------------------------------------------------------------- 
  Register: IlaSpare - General Purpose Register
    Bits: 31:0  IlaSpare(rw) - General use register.
*/
...
#define   NFP_ILAX_CSR_IlaErrStat_InvalidTag                 (1 << 13)
#define   NFP_ILAX_CSR_IlaErrStat_RxErrAll                   (1 << 12)
#define   NFP_ILAX_CSR_IlaErrStat_CppTBadCmd                 (1 << 11)
#define   NFP_ILAX_CSR_IlaErrStat_TgtWrStartErr              (1 << 10)
#define   NFP_ILAX_CSR_IlaErrStat_CppTCPullErr               (1 << 9)
#define   NFP_ILAX_CSR_IlaErrStat_CppTCPushErr               (1 << 8)
#define   NFP_ILAX_CSR_IlaErrStat_TgtWrEndErr                (1 << 7)
#define   NFP_ILAX_CSR_IlaErrStat_RxErr                      (1 << 6)
#define   NFP_ILAX_CSR_IlaErrStat_EopErr                     (1 << 5)
#define   NFP_ILAX_CSR_IlaErrStat_TimeOutErr                 (1 << 1)
#define   NFP_ILAX_CSR_IlaErrStat_IlaRxAlignErr              (1 << 0)
/*---------------------------------------------------------------- 
  Register: IlaErrMask - ILA Error Mask Register.
    Bits: 13    InvalidTagMask(rw) - Set to mask Invalid_TAG error interrupts.
    Bits: 12    RxErrAllMask(rw) - Set to mask Rx Err_All error interrupts.
...
#define   NFP_ILAX_CSR_IlaErrMask_InvalidTagMask             (1 << 13)
#define   NFP_ILAX_CSR_IlaErrMask_RxErrAllMask               (1 << 12)
#define   NFP_ILAX_CSR_IlaErrMask_CppTBadCmdMask             (1 << 11)
#define   NFP_ILAX_CSR_IlaErrMask_TgtWrStartErrMask          (1 << 10)
#define   NFP_ILAX_CSR_IlaErrMask_CppTCPullErrMask           (1 << 9)
#define   NFP_ILAX_CSR_IlaErrMask_CppTCPushErrMask           (1 << 8)
#define   NFP_ILAX_CSR_IlaErrMask_TgtWrEndErrMask            (1 << 7)
#define   NFP_ILAX_CSR_IlaErrMask_RxErrMask                  (1 << 6)
#define   NFP_ILAX_CSR_IlaErrMask_EopErrMask                 (1 << 5)
#define   NFP_ILAX_CSR_IlaErrMask_TimeOutErrMask             (1 << 1)
#define   NFP_ILAX_CSR_IlaErrMask_IlaRxAlignErrMask          (1 << 0)
/*---------------------------------------------------------------- 
  Register: IlaErrCnt - ILA Error Counter
    Bits: 29:20 EopErrCnt(ro) - Stores the ILA EOP_ERR Counter.
    Bits: 19:10 CppPullDataErrCnt(ro) - Stores the CPP Pull Data Error Counter.
...
#define   NFP_ILAX_CSR_IlaSramCtrl_BC2_0                     (1 << 14)
#define   NFP_ILAX_CSR_IlaSramCtrl_BC1_0                     (1 << 13)
#define   NFP_ILAX_CSR_IlaSramCtrl_Test1B0                   (1 << 12)
#define   NFP_ILAX_CSR_IlaSramCtrl_Test1Test1A0              (1 << 11)
#define   NFP_ILAX_CSR_IlaSramCtrl_RaRmOveride0              (1 << 10)
...
#define   NFP_ILAX_CSR_IlaTxErrCtrl_IlaTxErrDisable          (1 << 0)
