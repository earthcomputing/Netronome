...
#define   NFP_IMUX_CFG_CFG_ERROR_SUPPRESS                    (1 << 5)
#define   NFP_IMUX_CFG_CFG_ERROR_IGNORE                      (1 << 4)
#define   NFP_IMUX_CFG_CFG_DISABLE_DUAL_READ                 (1 << 3)
#define     NFP_IMUX_CFG_CFG_DISABLE_DUAL_READ_ENABLED       (0 << 3)
#define     NFP_IMUX_CFG_CFG_DISABLE_DUAL_READ_DISABLED      (1 << 3)
...
#define   NFP_IMUX_CFG_CFG_BULK_ALIGN                        (1 << 0)
#define     NFP_IMUX_CFG_CFG_BULK_ALIGN_ENFORCE              (0 << 0)
#define     NFP_IMUX_CFG_CFG_BULK_ALIGN_IGNORE               (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_IMUX_LE_LOOKUP_ENGINE_CONFIG_RESET_ERR_COUNTER (1 << 8)
...
#define   NFP_IMUX_LE_ALGORITHMIC_TABLE_LOCATION_LOCATION    (1 << 0)
#define     NFP_IMUX_LE_ALGORITHMIC_TABLE_LOCATION_LOCATION_INTERNAL (0 << 0)
#define     NFP_IMUX_LE_ALGORITHMIC_TABLE_LOCATION_LOCATION_EXTERNAL (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_IMUX_LB_MULB_HASH_MULTIPLY_MULT63              (1 << 3)
#define   NFP_IMUX_LB_MULB_HASH_MULTIPLY_MULT53              (1 << 2)
#define   NFP_IMUX_LB_MULB_HASH_MULTIPLY_MULT36              (1 << 1)
#define   NFP_IMUX_LB_MULB_HASH_MULTIPLY_MULT4               (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_IMUX_LB_MULB_HASH_SBOXES_HASH_SBOX_ENABLE      (1 << 4)
...
#define   NFP_IMUX_CFG_ConfigCPP_CPPErrorSuppress            (1 << 5)
#define   NFP_IMUX_CFG_ConfigCPP_CPPErrorIgnore              (1 << 4)
#define   NFP_IMUX_CFG_ConfigCPP_DisableDualChRead           (1 << 3)
#define     NFP_IMUX_CFG_ConfigCPP_DisableDualChRead_Enabled (0 << 3)
#define     NFP_IMUX_CFG_ConfigCPP_DisableDualChRead_Disabled (1 << 3)
...
#define   NFP_IMUX_CFG_ConfigCPP_IgnBulkAlign                (1 << 0)
#define     NFP_IMUX_CFG_ConfigCPP_IgnBulkAlign_ENFORCE      (0 << 0)
#define     NFP_IMUX_CFG_ConfigCPP_IgnBulkAlign_IGNORE       (1 << 0)
/*---------------------------------------------------------------- 
  Register: ConfigVQDR[4] - Virtual QDR X Configuration Register
    Bits: 21:20 QueueType(rw) - Type of queues in the channel, similar to IXP IgnoreEOP and IgnoreSegCnt
    Bits: 15:0  MemWinBase(rw) - Bits [16;24] of full 40-bit MU address space for the base of the virtual QDR channel
...
#define   NFP_IMUX_LE_LookupEngineConfig_Reset_Error_Counter (1 << 8)
...
#define   NFP_IMUX_LE_AlgorithmicTableLocation_Location      (1 << 0)
#define     NFP_IMUX_LE_AlgorithmicTableLocation_Location_Internal (0 << 0)
#define     NFP_IMUX_LE_AlgorithmicTableLocation_Location_External (1 << 0)
/*---------------------------------------------------------------- 
  Register: DirectTableLocation - Lookup Engine Direct Table Type. Read/Write registers define the bits[32:28] of the Small Direct lookup table DLUT32 and DLUT24
    Bits:  5:1  Address(rw) - Upper address bits 32:28 of Small Direct Lookup Table - DLUT24 and DLUT32
*/
...
#define   NFP_IMUX_LB_MULBHashMultiply_Mult63                (1 << 3)
#define   NFP_IMUX_LB_MULBHashMultiply_Mult53                (1 << 2)
#define   NFP_IMUX_LB_MULBHashMultiply_Mult36                (1 << 1)
#define   NFP_IMUX_LB_MULBHashMultiply_Mult4                 (1 << 0)
/*---------------------------------------------------------------- 
  Register: MULBHashSBoxes - Memory Unit Load Balancer Hash SBoxes
    Bits:  4    HashSboxEnable(rw) - If deasserted, residue is not put through sboxes.
    Bits:  3:0  HashSbox(rw) - Number of sboxes to use, minus 1 - bottom 4*(n+1) bits are put through sboxes, rest not.
...
#define   NFP_IMUX_LB_MULBHashSBoxes_HashSboxEnable          (1 << 4)
