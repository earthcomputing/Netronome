...
#define   NFP_CTMX_CFG_CFG_ERROR_SUPPRESS                    (1 << 5)
#define   NFP_CTMX_CFG_CFG_ERROR_IGNORE                      (1 << 4)
#define   NFP_CTMX_CFG_CFG_DISABLE_DUAL_READ                 (1 << 3)
#define     NFP_CTMX_CFG_CFG_DISABLE_DUAL_READ_ENABLED       (0 << 3)
#define     NFP_CTMX_CFG_CFG_DISABLE_DUAL_READ_DISABLED      (1 << 3)
...
#define   NFP_CTMX_CFG_CFG_BULK_ALIGN                        (1 << 0)
#define     NFP_CTMX_CFG_CFG_BULK_ALIGN_ENFORCE              (0 << 0)
#define     NFP_CTMX_CFG_CFG_BULK_ALIGN_IGNORE               (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_CTMX_PKT_MU_PE_WQ_CONFIG_MU_PE_WQ_CONFIG       (1 << 0)
#define     NFP_CTMX_PKT_MU_PE_WQ_CONFIG_MU_PE_WQ_CONFIG_SENDONLAST (0 << 0)
#define     NFP_CTMX_PKT_MU_PE_WQ_CONFIG_MU_PE_WQ_CONFIG_SENDONFIRST (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_CTMX_PKT_MU_PE_LB_CONFIG_MU_PE_LB_CONFIG       (1 << 0)
#define     NFP_CTMX_PKT_MU_PE_LB_CONFIG_MU_PE_LB_CONFIG_DYNAMIC (0 << 0)
#define     NFP_CTMX_PKT_MU_PE_LB_CONFIG_MU_PE_LB_CONFIG_STATIC (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_CTMX_MISC_XPB_ERR_CONFIG_XPB_WRITE_IF_ERR      (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_CTMX_MISC_XPB_TIMEOUT_ERR_STAT_XPB_TIMEOUT_ERR (1 << 14)
...
#define   NFP_CTMX_MISC_XPB_WR_ERR_STAT_XPB_WR_ERR_MULTI     (1 << 30)
#define   NFP_CTMX_MISC_XPB_WR_ERR_STAT_XPB_WR_ERR_SINGLE    (1 << 29)
#define   NFP_CTMX_MISC_XPB_WR_ERR_STAT_XPB_WR_ERR_GLOBAL    (1 << 28)
...
#define   NFP_CTMX_MISC_RING_BASE_STATUS_TYPE                (1 << 28)
#define     NFP_CTMX_MISC_RING_BASE_STATUS_TYPE_EMPTY        (0 << 28)
#define     NFP_CTMX_MISC_RING_BASE_STATUS_TYPE_FULL         (1 << 28)
...
#define   NFP_CTMX_CFG_ConfigCPP_CPPErrorSuppress            (1 << 5)
#define   NFP_CTMX_CFG_ConfigCPP_CPPErrorIgnore              (1 << 4)
#define   NFP_CTMX_CFG_ConfigCPP_DisableDualChRead           (1 << 3)
#define     NFP_CTMX_CFG_ConfigCPP_DisableDualChRead_Enabled (0 << 3)
#define     NFP_CTMX_CFG_ConfigCPP_DisableDualChRead_Disabled (1 << 3)
...
#define   NFP_CTMX_CFG_ConfigCPP_IgnBulkAlign                (1 << 0)
#define     NFP_CTMX_CFG_ConfigCPP_IgnBulkAlign_ENFORCE      (0 << 0)
#define     NFP_CTMX_CFG_ConfigCPP_IgnBulkAlign_IGNORE       (1 << 0)
/*---------------------------------------------------------------- 
  Register: ConfigVQDR[4] - Virtual QDR X Configuration Register
    Bits: 21:20 QueueType(rw) - Type of queues in the channel, similar to IXP IgnoreEOP and IgnoreSegCnt
    Bits: 15:0  MemWinBase(rw) - Bits [16;24] of full 40-bit MU address space for the base of the virtual QDR channel
...
#define   NFP_CTMX_PKT_MUPEWQConfig_MUPEWQConfig             (1 << 0)
#define     NFP_CTMX_PKT_MUPEWQConfig_MUPEWQConfig_SendOnLast (0 << 0)
#define     NFP_CTMX_PKT_MUPEWQConfig_MUPEWQConfig_SendOnFirst (1 << 0)
/*---------------------------------------------------------------- 
  Register: MUPECredits[4] - MU PE Credit Buckets
    Bits: 26:16 MUPEPacketCredits(ro) - Packet Credits
    Bits:  8:0  MUPEBufferCredits(ro) - Buffer Credits
...
#define   NFP_CTMX_PKT_MUPELBConfig_MUPELBConfig             (1 << 0)
#define     NFP_CTMX_PKT_MUPELBConfig_MUPELBConfig_Dynamic   (0 << 0)
#define     NFP_CTMX_PKT_MUPELBConfig_MUPELBConfig_Static    (1 << 0)
/*---------------------------------------------------------------- 
  Register: MUPEActivePacketCount - Packet Stats -- Active Packet Count
  Register: MUPEPeakPacketCount - Packet Stats -- Peak Packet Count
    Bits:  9:0  Stats(ro) - Packet Count Stats
...
#define   NFP_CTMX_MISC_XpbErrConfig_XpbWrIfErr              (1 << 0)
/*---------------------------------------------------------------- 
  Register: XpbTOErrStat - XPB Timeout Error Status Register
    Bits: 14    XpbTOErr(rwc) - XPB Timeout Error. If '1', the requested XPB CLUSTER_ID and DEVICE_ID combination did not result in a XPB response on the XPB Bus. Requesting a non-existent XPB target is not allowed on the XPB bus. If '0', no current error.
    Bits: 13:8  XpbClId(rwc) - This is the XPB CLUSTER ID of the XPB request that caused the XPB Timeout Error.
...
#define   NFP_CTMX_MISC_XpbTOErrStat_XpbTOErr                (1 << 14)
...
#define   NFP_CTMX_MISC_XpbWrErrStat_XpbWrErrMulti           (1 << 30)
#define   NFP_CTMX_MISC_XpbWrErrStat_XpbWrErrSingle          (1 << 29)
#define   NFP_CTMX_MISC_XpbWrErrStat_XpbWrErrGlobal          (1 << 28)
...
#define     NFP_CTMX_MISC_Ring_Base_Size_8k                  (6)
#define     NFP_CTMX_MISC_Ring_Base_Size_16k                 (7)
#define   NFP_CTMX_MISC_Ring_Base_StatusType                 (1 << 28)
#define     NFP_CTMX_MISC_Ring_Base_StatusType_Empty         (0 << 28)
#define     NFP_CTMX_MISC_Ring_Base_StatusType_Full          (1 << 28)
