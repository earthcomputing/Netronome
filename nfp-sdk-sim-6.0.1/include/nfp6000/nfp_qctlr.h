...
#define   NFP_QCTLR_STS_LO_RPTR_ENABLE                       (1 << 31)
#define   NFP_QCTLR_STS_LO_OVERFLOWED                        (1 << 30)
#define   NFP_QCTLR_STS_LO_UNDERFLOWED                       (1 << 29)
#define   NFP_QCTLR_STS_LO_WMREACHED                         (1 << 28)
#define   NFP_QCTLR_STS_LO_FULL                              (1 << 27)
#define   NFP_QCTLR_STS_LO_EMPTY                             (1 << 26)
...
#define   NFP_QCTLR_STS_HI_OVERFLOWED                        (1 << 30)
#define   NFP_QCTLR_STS_HI_UNDERFLOWED                       (1 << 29)
#define   NFP_QCTLR_STS_HI_WMREACHED                         (1 << 28)
#define   NFP_QCTLR_STS_HI_FULL                              (1 << 27)
#define   NFP_QCTLR_STS_HI_EMPTY                             (1 << 26)
...
#define   NFP_QCTLR_ConfigStatusLow_ReadPtrEnable            (1 << 31)
#define   NFP_QCTLR_ConfigStatusLow_Overflowed               (1 << 30)
#define   NFP_QCTLR_ConfigStatusLow_Underflowed              (1 << 29)
#define   NFP_QCTLR_ConfigStatusLow_WMReached                (1 << 28)
#define   NFP_QCTLR_ConfigStatusLow_Full                     (1 << 27)
#define   NFP_QCTLR_ConfigStatusLow_Empty                    (1 << 26)
...
#define   NFP_QCTLR_ConfigStatusHigh_Overflowed              (1 << 30)
#define   NFP_QCTLR_ConfigStatusHigh_Underflowed             (1 << 29)
#define   NFP_QCTLR_ConfigStatusHigh_WMReached               (1 << 28)
#define   NFP_QCTLR_ConfigStatusHigh_Full                    (1 << 27)
#define   NFP_QCTLR_ConfigStatusHigh_Empty                   (1 << 26)
