...
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL0_BL_QUE_FULL   (1 << 39)
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL0_BL_QUE_EMPTY  (1 << 38)
...
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL1_BL_QUE_FULL   (1 << 39)
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL1_BL_QUE_EMPTY  (1 << 38)
...
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL2_BL_QUE_FULL   (1 << 39)
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL2_BL_QUE_EMPTY  (1 << 38)
...
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL3_BL_QUE_FULL   (1 << 39)
#define   NFP_NBI_TM_TMBUFFERLIST_BL_QUE_CTRL3_BL_QUE_EMPTY  (1 << 38)
...
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_OOBFCENABLE (1 << 16)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_OOBFCENABLE_DISABLE (0 << 16)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_OOBFCENABLE_ENABLE (1 << 16)
...
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SEQUENCER0ENABLE (1 << 10)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SEQUENCER0ENABLE_DISABLE (0 << 10)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SEQUENCER0ENABLE_ENABLE (1 << 10)
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_ERR_POISON_ENA (1 << 9)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_ERR_POISON_ENA_DISABLE (0 << 9)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_ERR_POISON_ENA_ENABLE (1 << 9)
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SCHEDULERENABLE (1 << 8)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SCHEDULERENABLE_DISABLE (0 << 8)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SCHEDULERENABLE_ENABLE (1 << 8)
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SHAPERENABLE (1 << 7)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SHAPERENABLE_DISABLE (0 << 7)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_SHAPERENABLE_ENABLE (1 << 7)
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_MINIPACKETFCENABLE (1 << 6)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_MINIPACKETFCENABLE_DISABLE (0 << 6)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_MINIPACKETFCENABLE_ENABLE (1 << 6)
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_CHANNELLEVELSELECT (1 << 5)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_CHANNELLEVELSELECT_LEVEL_0 (0 << 5)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_CHANNELLEVELSELECT_LEVEL_1 (1 << 5)
...
#define   NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_L1INPUTSELECT (1 << 0)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_L1INPUTSELECT_L1_DISABLE (0 << 0)
#define     NFP_NBI_TMX_CSR_TRAFFIC_MANAGER_CONFIG_L1INPUTSELECT_L1_ENABLE (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_TMX_CSR_BLQ_EVENT_DIS_BLQ_EVENT_FIFO_FULL_ASSERT (1 << 20)
...
#define   NFP_NBI_TMX_CSR_EGRESS_RATE_LIMIT_EGRESS_RATE_LIMIT_OFF (1 << 2)
#define     NFP_NBI_TMX_CSR_EGRESS_RATE_LIMIT_EGRESS_RATE_LIMIT_OFF_ON (0 << 2)
#define     NFP_NBI_TMX_CSR_EGRESS_RATE_LIMIT_EGRESS_RATE_LIMIT_OFF_OFF (1 << 2)
...
#define   NFP_NBI_TMX_CSR_MINIPKT_CREDIT_CONFIG_MINIPACKETFCMODE (1 << 24)
#define     NFP_NBI_TMX_CSR_MINIPKT_CREDIT_CONFIG_MINIPACKETFCMODE_MODE_0 (0 << 24)
#define     NFP_NBI_TMX_CSR_MINIPKT_CREDIT_CONFIG_MINIPACKETFCMODE_MODE_1 (1 << 24)
...
*/
#define NFP_NBI_TMX_CSR_MINIPKT_FREE_POOL_CREDIT0            0x00000304
#define NFP_NBI_TMX_CSR_MINIPKT_FREE_POOL_CREDIT1            0x00000308
...
#define   NFP_NBI_TM_Q_QUEUE_STATUS_QUEUEFULL                (1 << 13)
...
#define   NFP_NBI_TM_Q_QUEUE_CONFIG_DROPRATERANGESELECT      (1 << 10)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_DROPRATERANGESELECT_A  (0 << 10)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_DROPRATERANGESELECT_B  (1 << 10)
...
#define   NFP_NBI_TM_Q_QUEUE_CONFIG_REDENABLE                (1 << 2)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_REDENABLE_DISABLED     (0 << 2)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_REDENABLE_ENABLED      (1 << 2)
#define   NFP_NBI_TM_Q_QUEUE_CONFIG_DROPENABLE               (1 << 1)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_DROPENABLE_DISABLED    (0 << 1)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_DROPENABLE_ENABLED     (1 << 1)
#define   NFP_NBI_TM_Q_QUEUE_CONFIG_QUEUEENABLE              (1 << 0)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_QUEUEENABLE_DISABLE    (0 << 0)
#define     NFP_NBI_TM_Q_QUEUE_CONFIG_QUEUEENABLE_ENABLE     (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP1ENABLE     (1 << 2)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP1ENABLE_DISABLE (0 << 2)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP1ENABLE_ENABLE (1 << 2)
#define   NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP0ENABLE     (1 << 1)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP0ENABLE_DISABLE (0 << 1)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_SP0ENABLE_ENABLE (1 << 1)
#define   NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_DWRRENABLE    (1 << 0)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_DWRRENABLE_DISABLE (0 << 0)
#define     NFP_NBI_TMX_SCH_CSR_SCHEDULER_CONFIG_DWRRENABLE_ENABLE (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_NBI_TMX_SHP_SHAPER_STATUS_SHAPEROPEN           (1 << 17)
#define     NFP_NBI_TMX_SHP_SHAPER_STATUS_SHAPEROPEN_CLOSED  (0 << 17)
#define     NFP_NBI_TMX_SHP_SHAPER_STATUS_SHAPEROPEN_OPEN    (1 << 17)
...
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl0_BLQFull         (1 << 39)
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl0_BLQEmpty        (1 << 38)
...
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl1_BLQFull         (1 << 39)
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl1_BLQEmpty        (1 << 38)
...
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl2_BLQFull         (1 << 39)
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl2_BLQEmpty        (1 << 38)
...
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl3_BLQFull         (1 << 39)
#define   NFP_NBI_TM_TMBufferList_BLQueCtrl3_BLQEmpty        (1 << 38)
...
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_OOBFCEnable   (1 << 16)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_OOBFCEnable_Disable (0 << 16)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_OOBFCEnable_Enable (1 << 16)
...
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_Sequencer0Enable (1 << 10)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_Sequencer0Enable_Disable (0 << 10)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_Sequencer0Enable_Enable (1 << 10)
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_ErrPoisonEna  (1 << 9)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ErrPoisonEna_Disable (0 << 9)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ErrPoisonEna_Enable (1 << 9)
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_SchedulerEnable (1 << 8)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_SchedulerEnable_Disable (0 << 8)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_SchedulerEnable_Enable (1 << 8)
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_ShaperEnable  (1 << 7)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ShaperEnable_Disable (0 << 7)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ShaperEnable_Enable (1 << 7)
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_MiniPacketFCEnable (1 << 6)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_MiniPacketFCEnable_Disable (0 << 6)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_MiniPacketFCEnable_Enable (1 << 6)
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_ChannelLevelSelect (1 << 5)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ChannelLevelSelect_Level_0 (0 << 5)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_ChannelLevelSelect_Level_1 (1 << 5)
...
#define   NFP_NBI_TMX_CSR_TrafficManagerConfig_L1InputSelect (1 << 0)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_L1InputSelect_L1_Disable (0 << 0)
#define     NFP_NBI_TMX_CSR_TrafficManagerConfig_L1InputSelect_L1_Enable (1 << 0)
/*---------------------------------------------------------------- 
  Register: DropRate - Configurable drop rate that is programmable for each queue depth range
    Bits: 23:21 DropRateRangeB3(rw) - Drop Rate for Queue Depth Range B-3. Top 75% to 100% of the descriptor queue. Packets will be dropped n% of the time if the queue depth is within this range
    Bits: 20:18 DropRateRangeB2(rw) - Drop Rate for Queue Depth Range B-2. 50% to 74% full. Packets will be dropped n% of the time if the queue depth is within this range
...
#define   NFP_NBI_TMX_CSR_BlqEvent_DisBLQEventFifoFullAssert (1 << 20)
...
#define   NFP_NBI_TMX_CSR_EgressRateLimit_EgressRateLimitOff (1 << 2)
#define     NFP_NBI_TMX_CSR_EgressRateLimit_EgressRateLimitOff_on (0 << 2)
#define     NFP_NBI_TMX_CSR_EgressRateLimit_EgressRateLimitOff_off (1 << 2)
...
#define   NFP_NBI_TMX_CSR_MiniPktCreditConfig_MiniPacketFCMode (1 << 24)
#define     NFP_NBI_TMX_CSR_MiniPktCreditConfig_MiniPacketFCMode_Mode_0 (0 << 24)
#define     NFP_NBI_TMX_CSR_MiniPktCreditConfig_MiniPacketFCMode_Mode_1 (1 << 24)
...
/*---------------------------------------------------------------- 
  Register: MiniPktFreePoolCredit[2] - MiniPacket Transmit Free Pool Credit Counter. Read only free pool credit counters
    Bits:  9:0  FPCreditCounter(ro) - MiniPacket Transmit Free Pool Credit Counter. Read only counter of the free pool credits remaining
*/
#define NFP_NBI_TMX_CSR_MiniPktFreePoolCredit0               0x00000304
#define NFP_NBI_TMX_CSR_MiniPktFreePoolCredit1               0x00000308
...
#define   NFP_NBI_TM_Q_QueueStatus_QueueFull                 (1 << 13)
...
#define   NFP_NBI_TM_Q_QueueConfig_DropRateRangeSelect       (1 << 10)
#define     NFP_NBI_TM_Q_QueueConfig_DropRateRangeSelect_A   (0 << 10)
#define     NFP_NBI_TM_Q_QueueConfig_DropRateRangeSelect_B   (1 << 10)
...
#define   NFP_NBI_TM_Q_QueueConfig_REDEnable                 (1 << 2)
#define     NFP_NBI_TM_Q_QueueConfig_REDEnable_Disabled      (0 << 2)
#define     NFP_NBI_TM_Q_QueueConfig_REDEnable_Enabled       (1 << 2)
#define   NFP_NBI_TM_Q_QueueConfig_DropEnable                (1 << 1)
#define     NFP_NBI_TM_Q_QueueConfig_DropEnable_Disabled     (0 << 1)
#define     NFP_NBI_TM_Q_QueueConfig_DropEnable_Enabled      (1 << 1)
#define   NFP_NBI_TM_Q_QueueConfig_QueueEnable               (1 << 0)
#define     NFP_NBI_TM_Q_QueueConfig_QueueEnable_Disable     (0 << 0)
#define     NFP_NBI_TM_Q_QueueConfig_QueueEnable_Enable      (1 << 0)
/*---------------------------------------------------------------- 
  Register: QueueDropCount[1024] - Drop counter for each queue. There are a total of 1024 drop counters in the traffic manager.
    Bits: 31:0  DropCount(ro) - 32-bit drop counter to keep track of the number of packets dropped for this queue. The counter will saturate when the maximum number is reached.
*/
...
#define   NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP1Enable      (1 << 2)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP1Enable_Disable (0 << 2)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP1Enable_Enable (1 << 2)
#define   NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP0Enable      (1 << 1)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP0Enable_Disable (0 << 1)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_SP0Enable_Enable (1 << 1)
#define   NFP_NBI_TMX_SCH_CSR_SchedulerConfig_DWRREnable     (1 << 0)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_DWRREnable_Disable (0 << 0)
#define     NFP_NBI_TMX_SCH_CSR_SchedulerConfig_DWRREnable_Enable (1 << 0)
/*---------------------------------------------------------------- 
  Register: SchedulerWeight[128] - L0 Scheduler weight value to configure the relative bandwidth for each scheduler port. There are a total of 128 weight values to program in the level 0 scheduler.
    Bits: 23:0  Weight(rw) - Scheduler weight value. Program this memory with the desired weight value for the particular scheduler port. This memory is undefined at start-up and should be programmed or set to zero by software. If all weights for all ports of a particular port are set to zero, the scheduler will operate in round robin fashion. The weight value will configure the relative bandwidth for the port and is used to update the deficit value. The weight should be programmed to the desired relative bandwidth for this port as compared to the other ports on this scheduler.
*/
...
#define   NFP_NBI_TMX_SHP_ShaperStatus_ShaperOpen            (1 << 17)
#define     NFP_NBI_TMX_SHP_ShaperStatus_ShaperOpen_Closed   (0 << 17)
#define     NFP_NBI_TMX_SHP_ShaperStatus_ShaperOpen_Open     (1 << 17)
