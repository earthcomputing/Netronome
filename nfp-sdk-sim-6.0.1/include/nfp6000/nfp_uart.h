...
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_ENABLE (1 << 6)
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_NRZEN  (1 << 5)
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_RXTIMEOUT (1 << 4)
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_LINESTATUS (1 << 2)
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_TXDATAREQ (1 << 1)
#define   NFP_UART_UARTINTENDIVHI_UARTINTERRUPTENABLE_RXDATAVALID (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_UART_UARTFIFOCTRLINTSTS_FIFOCONTROL_TXFIFORESET (1 << 2)
#define   NFP_UART_UARTFIFOCTRLINTSTS_FIFOCONTROL_RXFIFORESET (1 << 1)
#define   NFP_UART_UARTFIFOCTRLINTSTS_FIFOCONTROL_FIFOEN     (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_UART_UARTFIFOCTRLINTSTS_INTERRUPTSTATUS_TIMEOUT (1 << 3)
...
#define   NFP_UART_UARTFIFOCTRLINTSTS_INTERRUPTSTATUS_PENDING (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_UART_LINECONTROL_DIVACCESS                     (1 << 7)
#define   NFP_UART_LINECONTROL_SETBREAK                      (1 << 6)
#define   NFP_UART_LINECONTROL_STICKYPAR                     (1 << 5)
#define   NFP_UART_LINECONTROL_EVENPAR                       (1 << 4)
#define   NFP_UART_LINECONTROL_PARITYEN                      (1 << 3)
#define   NFP_UART_LINECONTROL_STOPBITS                      (1 << 2)
#define     NFP_UART_LINECONTROL_STOPBITS_S1                 (0 << 2)
#define     NFP_UART_LINECONTROL_STOPBITS_S2                 (1 << 2)
...
#define   NFP_UART_LINESTATUS_FIFOERROR                      (1 << 7)
#define   NFP_UART_LINESTATUS_TXEMPTY                        (1 << 6)
#define   NFP_UART_LINESTATUS_TXDATAREQ                      (1 << 5)
#define   NFP_UART_LINESTATUS_BRKINT                         (1 << 4)
#define   NFP_UART_LINESTATUS_FRAMEERR                       (1 << 3)
#define   NFP_UART_LINESTATUS_PARERR                         (1 << 2)
#define   NFP_UART_LINESTATUS_OVERRUNERR                     (1 << 1)
#define   NFP_UART_LINESTATUS_DATARDY                        (1 << 0)
