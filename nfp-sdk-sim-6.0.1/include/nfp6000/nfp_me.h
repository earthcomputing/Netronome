...
#define   NFP_ME_USTORE_ADDRESS_ECS                          (1 << 31)
#define     NFP_ME_USTORE_ADDRESS_ECS_NORMAL                 (0 << 31)
#define     NFP_ME_USTORE_ADDRESS_ECS_RW                     (1 << 31)
#define   NFP_ME_USTORE_ADDRESS_WRITE_STROBE                 (1 << 30)
#define     NFP_ME_USTORE_ADDRESS_WRITE_STROBE_DISABLE       (0 << 30)
#define     NFP_ME_USTORE_ADDRESS_WRITE_STROBE_ENABLE        (1 << 30)
#define   NFP_ME_USTORE_ADDRESS_DATA_INVERT                  (1 << 29)
#define     NFP_ME_USTORE_ADDRESS_DATA_INVERT_DISABLE        (0 << 29)
#define     NFP_ME_USTORE_ADDRESS_DATA_INVERT_ENABLE         (1 << 29)
...
#define   NFP_ME_USTORE_ERROR_STATUS_UNCORRECTABLE           (1 << 31)
#define     NFP_ME_USTORE_ERROR_STATUS_UNCORRECTABLE_NOT_OCCURED (0 << 31)
#define     NFP_ME_USTORE_ERROR_STATUS_UNCORRECTABLE_OCCURED (1 << 31)
...
#define   NFP_ME_CTX_ENABLES_IN_USE                          (1 << 31)
#define     NFP_ME_CTX_ENABLES_IN_USE_8CTX                   (0 << 31)
#define     NFP_ME_CTX_ENABLES_IN_USE_4CTX                   (1 << 31)
#define   NFP_ME_CTX_ENABLES_PRN_MODE                        (1 << 30)
#define     NFP_ME_CTX_ENABLES_PRN_MODE_ME_INSTR             (0 << 30)
#define     NFP_ME_CTX_ENABLES_PRN_MODE_EVERY_CYCLE          (1 << 30)
#define   NFP_ME_CTX_ENABLES_USTORE_ECC_ERR                  (1 << 29)
#define   NFP_ME_CTX_ENABLES_USTORE_ECC_ENABLE               (1 << 28)
#define     NFP_ME_CTX_ENABLES_USTORE_ECC_ENABLE_DISABLE     (0 << 28)
#define     NFP_ME_CTX_ENABLES_USTORE_ECC_ENABLE_ENABLE      (1 << 28)
#define   NFP_ME_CTX_ENABLES_BREAKPOINT                      (1 << 27)
#define   NFP_ME_CTX_ENABLES_REG_PAR_ERR                     (1 << 25)
#define     NFP_ME_CTX_ENABLES_REG_PAR_ERR_NONE              (0 << 25)
#define     NFP_ME_CTX_ENABLES_REG_PAR_ERR_DETECTED          (1 << 25)
#define   NFP_ME_CTX_ENABLES_LOCAL_MEMORY_ECC_ENABLE         (1 << 23)
#define     NFP_ME_CTX_ENABLES_LOCAL_MEMORY_ECC_ENABLE_DISABLE (0 << 23)
#define     NFP_ME_CTX_ENABLES_LOCAL_MEMORY_ECC_ENABLE_ENABLE (1 << 23)
#define   NFP_ME_CTX_ENABLES_LM_ADDR_3_GLOB                  (1 << 22)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_3_GLOB_RELATIVE       (0 << 22)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_3_GLOB_GLOBAL         (1 << 22)
#define   NFP_ME_CTX_ENABLES_LM_ADDR_2_GLOB                  (1 << 21)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_2_GLOB_RELATIVE       (0 << 21)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_2_GLOB_GLOBAL         (1 << 21)
#define   NFP_ME_CTX_ENABLES_NN_SEND_CONFIGURATION           (1 << 20)
#define     NFP_ME_CTX_ENABLES_NN_SEND_CONFIGURATION_NEXT    (0 << 20)
#define     NFP_ME_CTX_ENABLES_NN_SEND_CONFIGURATION_SELF    (1 << 20)
...
#define   NFP_ME_CTX_ENABLES_LM_ADDR_1_GLOB                  (1 << 17)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_1_GLOB_RELATIVE       (0 << 17)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_1_GLOB_GLOBAL         (1 << 17)
#define   NFP_ME_CTX_ENABLES_LM_ADDR_0_GLOB                  (1 << 16)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_0_GLOB_RELATIVE       (0 << 16)
#define     NFP_ME_CTX_ENABLES_LM_ADDR_0_GLOB_GLOBAL         (1 << 16)
...
#define   NFP_ME_CC_ENABLE_CCCE                              (1 << 13)
/*---------------------------------------------------------------- 
...
#define   NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT1                (1 << 1)
#define     NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT1_VAL0         (0 << 1)
#define     NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT1_VAL1         (1 << 1)
#define   NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT0                (1 << 0)
#define     NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT0_VAL0         (0 << 0)
#define     NFP_ME_PC_BREAKPOINT_STATUS_BRKPNT0_VAL1         (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ME_LM_ERROR_STATUS_UNCORRECTABLE               (1 << 31)
#define     NFP_ME_LM_ERROR_STATUS_UNCORRECTABLE_NOT_OCCURED (0 << 31)
#define     NFP_ME_LM_ERROR_STATUS_UNCORRECTABLE_OCCURED     (1 << 31)
...
#define   NFP_ME_INDIRECT_CTX_STS_RR                         (1 << 31)
#define     NFP_ME_INDIRECT_CTX_STS_RR_NOT_READY             (0 << 31)
#define     NFP_ME_INDIRECT_CTX_STS_RR_READY                 (1 << 31)
...
#define   NFP_ME_ACTIVE_CTX_STS_AB0                          (1 << 31)
#define     NFP_ME_ACTIVE_CTX_STS_AB0_NOT_ACTIVE             (0 << 31)
#define     NFP_ME_ACTIVE_CTX_STS_AB0_ACTIVE                 (1 << 31)
...
#define   NFP_ME_CTXSGLEVT_VOLUNTARY                         (1 << 0)
/*---------------------------------------------------------------- 
...
#define   NFP_ME_NEXT_NEIGHBOR_SIGNAL_THIS_CTX               (1 << 7)
#define     NFP_ME_NEXT_NEIGHBOR_SIGNAL_THIS_CTX_USECTX      (0 << 7)
#define     NFP_ME_NEXT_NEIGHBOR_SIGNAL_THIS_CTX_SAMECTX     (1 << 7)
...
#define   NFP_ME_PREV_NEIGHBOR_SIGNAL_THIS_CTX               (1 << 7)
#define     NFP_ME_PREV_NEIGHBOR_SIGNAL_THIS_CTX_USECTX      (0 << 7)
#define     NFP_ME_PREV_NEIGHBOR_SIGNAL_THIS_CTX_SAMECTX     (1 << 7)
...
#define   NFP_ME_SAME_ME_SIGNAL_NEXT_CTX                     (1 << 7)
#define     NFP_ME_SAME_ME_SIGNAL_NEXT_CTX_USECTX            (0 << 7)
#define     NFP_ME_SAME_ME_SIGNAL_NEXT_CTX_NEXT              (1 << 7)
...
#define   NFP_ME_MISC_CONTROL_REQUEST_ON_CS_ECC_ERROR        (1 << 30)
#define     NFP_ME_MISC_CONTROL_REQUEST_ON_CS_ECC_ERROR_NO_REQUEST (0 << 30)
#define     NFP_ME_MISC_CONTROL_REQUEST_ON_CS_ECC_ERROR_REQUEST (1 << 30)
#define   NFP_ME_MISC_CONTROL_INTERRUPT                      (1 << 26)
#define     NFP_ME_MISC_CONTROL_INTERRUPT_NOT_INTERRUPTED    (0 << 26)
#define     NFP_ME_MISC_CONTROL_INTERRUPT_INTERRUPTED        (1 << 26)
#define   NFP_ME_MISC_CONTROL_ECC_CORR_GATE                  (1 << 25)
#define     NFP_ME_MISC_CONTROL_ECC_CORR_GATE_DISABLE        (0 << 25)
#define     NFP_ME_MISC_CONTROL_ECC_CORR_GATE_ENABLE         (1 << 25)
#define   NFP_ME_MISC_CONTROL_PARITY_ENBLE                   (1 << 24)
#define     NFP_ME_MISC_CONTROL_PARITY_ENBLE_DISABLE         (0 << 24)
#define     NFP_ME_MISC_CONTROL_PARITY_ENBLE_ENABLE          (1 << 24)
#define   NFP_ME_MISC_CONTROL_FORCE_BAR_PARITY               (1 << 23)
#define     NFP_ME_MISC_CONTROL_FORCE_BAR_PARITY_DISABLE     (0 << 23)
#define     NFP_ME_MISC_CONTROL_FORCE_BAR_PARITY_ENABLE      (1 << 23)
#define   NFP_ME_MISC_CONTROL_USTORE_ECC_CORRECT             (1 << 12)
#define     NFP_ME_MISC_CONTROL_USTORE_ECC_CORRECT_DISABLE   (0 << 12)
#define     NFP_ME_MISC_CONTROL_USTORE_ECC_CORRECT_ENABLE    (1 << 12)
#define   NFP_ME_MISC_CONTROL_THIRD_PARTY_ADDRESS_MODE       (1 << 4)
#define     NFP_ME_MISC_CONTROL_THIRD_PARTY_ADDRESS_MODE_40BIT (0 << 4)
#define     NFP_ME_MISC_CONTROL_THIRD_PARTY_ADDRESS_MODE_32BIT (1 << 4)
#define   NFP_ME_MISC_CONTROL_LEGACY_INDIRECT_REF_MODE       (1 << 3)
#define     NFP_ME_MISC_CONTROL_LEGACY_INDIRECT_REF_MODE_NORMAL (0 << 3)
#define     NFP_ME_MISC_CONTROL_LEGACY_INDIRECT_REF_MODE_LEGACY (1 << 3)
#define   NFP_ME_MISC_CONTROL_SHARE_USTORE                   (1 << 2)
#define     NFP_ME_MISC_CONTROL_SHARE_USTORE_NOT_SHARED      (0 << 2)
#define     NFP_ME_MISC_CONTROL_SHARE_USTORE_SHARED          (1 << 2)
#define   NFP_ME_MISC_CONTROL_LM_REGION_PULL                 (1 << 1)
#define     NFP_ME_MISC_CONTROL_LM_REGION_PULL_LOWER_HALF    (0 << 1)
#define     NFP_ME_MISC_CONTROL_LM_REGION_PULL_UPPER_HALF    (1 << 1)
#define   NFP_ME_MISC_CONTROL_LM_REGION_PUSH                 (1 << 0)
#define     NFP_ME_MISC_CONTROL_LM_REGION_PUSH_LOWER_HALF    (0 << 0)
#define     NFP_ME_MISC_CONTROL_LM_REGION_PUSH_UPPER_HALF    (1 << 0)
/*---------------------------------------------------------------- 
...
/*---------------------------------------------------------------- 
  Register: CmdIndirectRef1 - Command Indirect Reference Register Type 1
    Bits: 15:12 Target(rw) - Override value for the CPP command's target field.
    Bits: 11:7  Action(rw) - Override value for the CPP command's action field.
    Bits:  6:5  Token(rw) - Override value for the CPP command's token field.
    Bits:  2    OvTarget(rw) - Override enable for the TARGET field in this same CSR.
    Bits:  1    OvAction(rw) - Override enable for the Action field in this same CSR.
    Bits:  0    OvToken(rw) - Override enable for the Token field in this same CSR.
*/
#define NFP_ME_CMD_INDIRECT_REF_1                            0x00000194
#define   NFP_ME_CMD_INDIRECT_REF_1_TARGET(_x)               (((_x) & 0xf) << 12)
#define   NFP_ME_CMD_INDIRECT_REF_1_TARGET_of(_x)            (((_x) >> 12) & 0xf)
#define   NFP_ME_CMD_INDIRECT_REF_1_ACTION(_x)               (((_x) & 0x1f) << 7)
#define   NFP_ME_CMD_INDIRECT_REF_1_ACTION_of(_x)            (((_x) >> 7) & 0x1f)
#define   NFP_ME_CMD_INDIRECT_REF_1_TOKEN(_x)                (((_x) & 0x3) << 5)
#define   NFP_ME_CMD_INDIRECT_REF_1_TOKEN_of(_x)             (((_x) >> 5) & 0x3)
#define   NFP_ME_CMD_INDIRECT_REF_1_OV_TARGET                (1 << 2)
#define   NFP_ME_CMD_INDIRECT_REF_1_OV_ACTION                (1 << 1)
#define   NFP_ME_CMD_INDIRECT_REF_1_OV_TOKEN                 (1 << 0)
...
#define   NFP_ME_UstorAddr_EnableCS                          (1 << 31)
#define     NFP_ME_UstorAddr_EnableCS_NORMAL                 (0 << 31)
#define     NFP_ME_UstorAddr_EnableCS_RW                     (1 << 31)
#define   NFP_ME_UstorAddr_UstoreWrStrb                      (1 << 30)
#define     NFP_ME_UstorAddr_UstoreWrStrb_DISABLE            (0 << 30)
#define     NFP_ME_UstorAddr_UstoreWrStrb_ENABLE             (1 << 30)
#define   NFP_ME_UstorAddr_UstoreDataInvert                  (1 << 29)
#define     NFP_ME_UstorAddr_UstoreDataInvert_DISABLE        (0 << 29)
#define     NFP_ME_UstorAddr_UstoreDataInvert_ENABLE         (1 << 29)
...
#define   NFP_ME_UstorErrStat_UncorrectableErr               (1 << 31)
#define     NFP_ME_UstorErrStat_UncorrectableErr_NOT_OCCURED (0 << 31)
#define     NFP_ME_UstorErrStat_UncorrectableErr_OCCURED     (1 << 31)
...
#define   NFP_ME_CtxEnables_InUseContexts                    (1 << 31)
#define     NFP_ME_CtxEnables_InUseContexts_8CTX             (0 << 31)
#define     NFP_ME_CtxEnables_InUseContexts_4CTX             (1 << 31)
#define   NFP_ME_CtxEnables_PseudoRandNum                    (1 << 30)
#define     NFP_ME_CtxEnables_PseudoRandNum_ME_INSTR         (0 << 30)
#define     NFP_ME_CtxEnables_PseudoRandNum_EVERY_CYCLE      (1 << 30)
#define   NFP_ME_CtxEnables_CSEccError                       (1 << 29)
#define   NFP_ME_CtxEnables_CSEccEnable                      (1 << 28)
#define     NFP_ME_CtxEnables_CSEccEnable_DISABLE            (0 << 28)
#define     NFP_ME_CtxEnables_CSEccEnable_ENABLE             (1 << 28)
#define   NFP_ME_CtxEnables_Breakpoint                       (1 << 27)
#define   NFP_ME_CtxEnables_RegisterParityErr                (1 << 25)
#define     NFP_ME_CtxEnables_RegisterParityErr_NONE         (0 << 25)
#define     NFP_ME_CtxEnables_RegisterParityErr_DETECTED     (1 << 25)
#define   NFP_ME_CtxEnables_LMEccEnable                      (1 << 23)
#define     NFP_ME_CtxEnables_LMEccEnable_DISABLE            (0 << 23)
#define     NFP_ME_CtxEnables_LMEccEnable_ENABLE             (1 << 23)
#define   NFP_ME_CtxEnables_LMAddr3Global                    (1 << 22)
#define     NFP_ME_CtxEnables_LMAddr3Global_RELATIVE         (0 << 22)
#define     NFP_ME_CtxEnables_LMAddr3Global_GLOBAL           (1 << 22)
#define   NFP_ME_CtxEnables_LMAddr2Global                    (1 << 21)
#define     NFP_ME_CtxEnables_LMAddr2Global_RELATIVE         (0 << 21)
#define     NFP_ME_CtxEnables_LMAddr2Global_GLOBAL           (1 << 21)
#define   NFP_ME_CtxEnables_NNsendConfig                     (1 << 20)
#define     NFP_ME_CtxEnables_NNsendConfig_NEXT              (0 << 20)
#define     NFP_ME_CtxEnables_NNsendConfig_SELF              (1 << 20)
...
#define   NFP_ME_CtxEnables_LMAddr1Global                    (1 << 17)
#define     NFP_ME_CtxEnables_LMAddr1Global_RELATIVE         (0 << 17)
#define     NFP_ME_CtxEnables_LMAddr1Global_GLOBAL           (1 << 17)
#define   NFP_ME_CtxEnables_LMAddr0Global                    (1 << 16)
#define     NFP_ME_CtxEnables_LMAddr0Global_RELATIVE         (0 << 16)
#define     NFP_ME_CtxEnables_LMAddr0Global_GLOBAL           (1 << 16)
...
#define   NFP_ME_CondCodeEn_CurCndtnCodeEn                   (1 << 13)
/*---------------------------------------------------------------- 
  Register: CSRCtxPtr - CSR Context Pointer
    Bits:  2:0  CtxSelect(rw) - Selects which contexts Local CSR is accessed by local_csr_read, local_csr_write, and by the IA core.
*/
...
#define   NFP_ME_PcBreakpointStatus_PcBrkpnt1Status          (1 << 1)
#define     NFP_ME_PcBreakpointStatus_PcBrkpnt1Status_VAL0   (0 << 1)
#define     NFP_ME_PcBreakpointStatus_PcBrkpnt1Status_VAL1   (1 << 1)
#define   NFP_ME_PcBreakpointStatus_PcBrkpnt0Status          (1 << 0)
#define     NFP_ME_PcBreakpointStatus_PcBrkpnt0Status_VAL0   (0 << 0)
#define     NFP_ME_PcBreakpointStatus_PcBrkpnt0Status_VAL1   (1 << 0)
/*---------------------------------------------------------------- 
  Register: RegErrStatus - Information about parity errors detected on Datapath Regs
    Bits: 17:16 Type(ro) - Type of Register File where a Parity Error has been detected.
    Bits: 15:0  RegisterNumber(ro) - Entry Address of the Register File where a Parity Error has been detected. Unused upper bits will read 0.
...
#define   NFP_ME_LMErrStatus_UncorrectableErr                (1 << 31)
#define     NFP_ME_LMErrStatus_UncorrectableErr_NOT_OCCURED  (0 << 31)
#define     NFP_ME_LMErrStatus_UncorrectableErr_OCCURED      (1 << 31)
...
#define   NFP_ME_IndCtxStatus_ReadyToRun                     (1 << 31)
#define     NFP_ME_IndCtxStatus_ReadyToRun_NOT_READY         (0 << 31)
#define     NFP_ME_IndCtxStatus_ReadyToRun_READY             (1 << 31)
...
#define   NFP_ME_ActCtxStatus_AB0                            (1 << 31)
#define     NFP_ME_ActCtxStatus_AB0_NOT_ACTIVE               (0 << 31)
#define     NFP_ME_ActCtxStatus_AB0_ACTIVE                   (1 << 31)
...
#define   NFP_ME_CtxSglEvt_Signals(_x)                       (((_x) & 0x7fff) << 1)
#define   NFP_ME_CtxSglEvt_Signals_of(_x)                    (((_x) >> 1) & 0x7fff)
#define   NFP_ME_CtxSglEvt_VoluntaryWakeup                   (1 << 0)
/*---------------------------------------------------------------- 
  Register: IndCtxWkpEvt - Indirect Context Wakeup Events Register
  Register: ActCtxWkpEvt - Active Context Wakeup Events Register
    Bits: 16    AnyWakeEvnts(rw) - Any Wakeup Events. Set by the ANY token on a ctx_arb instruction. Note: this bit is undefined after a wakeup.
...
#define   NFP_ME_CtxWkpEvt_AnyWakeEvnts                      (1 << 16)
#define     NFP_ME_CtxWkpEvt_AnyWakeEvnts_ALL                (0 << 16)
#define     NFP_ME_CtxWkpEvt_AnyWakeEvnts_ANY                (1 << 16)
...
#define   NFP_ME_NxtNghbrSgl_ThisContext                     (1 << 7)
#define     NFP_ME_NxtNghbrSgl_ThisContext_USECTX            (0 << 7)
#define     NFP_ME_NxtNghbrSgl_ThisContext_SAMECTX           (1 << 7)
...
#define   NFP_ME_PrvNghbrSgl_ThisContext                     (1 << 7)
#define     NFP_ME_PrvNghbrSgl_ThisContext_USECTX            (0 << 7)
#define     NFP_ME_PrvNghbrSgl_ThisContext_SAMECTX           (1 << 7)
...
#define   NFP_ME_SameMESignal_NextContext                    (1 << 7)
#define     NFP_ME_SameMESignal_NextContext_USECTX           (0 << 7)
#define     NFP_ME_SameMESignal_NextContext_NEXT             (1 << 7)
...
#define   NFP_ME_MiscControl_ReqOnCsEccError                 (1 << 30)
#define     NFP_ME_MiscControl_ReqOnCsEccError_NO_REQUEST    (0 << 30)
#define     NFP_ME_MiscControl_ReqOnCsEccError_REQUEST       (1 << 30)
#define   NFP_ME_MiscControl_Interrupt                       (1 << 26)
#define     NFP_ME_MiscControl_Interrupt_NOT_INTERRUPTED     (0 << 26)
#define     NFP_ME_MiscControl_Interrupt_INTERRUPTED         (1 << 26)
#define   NFP_ME_MiscControl_ECCCorrGate                     (1 << 25)
#define     NFP_ME_MiscControl_ECCCorrGate_DISABLE           (0 << 25)
#define     NFP_ME_MiscControl_ECCCorrGate_ENABLE            (1 << 25)
#define   NFP_ME_MiscControl_ParityEnable                    (1 << 24)
#define     NFP_ME_MiscControl_ParityEnable_DISABLE          (0 << 24)
#define     NFP_ME_MiscControl_ParityEnable_ENABLE           (1 << 24)
#define   NFP_ME_MiscControl_ForceBadParity                  (1 << 23)
#define     NFP_ME_MiscControl_ForceBadParity_DISABLE        (0 << 23)
#define     NFP_ME_MiscControl_ForceBadParity_ENABLE         (1 << 23)
#define   NFP_ME_MiscControl_UstorECCCrctEn                  (1 << 12)
#define     NFP_ME_MiscControl_UstorECCCrctEn_DISABLE        (0 << 12)
#define     NFP_ME_MiscControl_UstorECCCrctEn_ENABLE         (1 << 12)
#define   NFP_ME_MiscControl_ThrdPrtyAdrMode                 (1 << 4)
#define     NFP_ME_MiscControl_ThrdPrtyAdrMode_40BIT         (0 << 4)
#define     NFP_ME_MiscControl_ThrdPrtyAdrMode_32BIT         (1 << 4)
#define   NFP_ME_MiscControl_LegacyIndRef                    (1 << 3)
#define     NFP_ME_MiscControl_LegacyIndRef_NORMAL           (0 << 3)
#define     NFP_ME_MiscControl_LegacyIndRef_LEGACY           (1 << 3)
#define   NFP_ME_MiscControl_ShareUstore                     (1 << 2)
#define     NFP_ME_MiscControl_ShareUstore_NOT_SHARED        (0 << 2)
#define     NFP_ME_MiscControl_ShareUstore_SHARED            (1 << 2)
#define   NFP_ME_MiscControl_LMRegionPull                    (1 << 1)
#define     NFP_ME_MiscControl_LMRegionPull_LOWER_HALF       (0 << 1)
#define     NFP_ME_MiscControl_LMRegionPull_UPPER_HALF       (1 << 1)
#define   NFP_ME_MiscControl_LMRegionPush                    (1 << 0)
#define     NFP_ME_MiscControl_LMRegionPush_LOWER_HALF       (0 << 0)
#define     NFP_ME_MiscControl_LMRegionPush_UPPER_HALF       (1 << 0)
/*---------------------------------------------------------------- 
  Register: PcBreakpoint0Mask - Mask register associated with PC Breakpoint 0
  Register: PcBreakpoint1Mask - Mask register associated with PC Breakpoint 1
    Bits: 13:0  PcMask(rw) - Masks the PC (program counter) bits which should not be considered for comparison against the value in the PcBrkpnt field of the PcBreakpoint CSR.
...
/*---------------------------------------------------------------- 
  Register: CmdIndirectRef1 - Command Indirect Reference Register Type 1
    ...
    Bits:  0    OvToken(rw) - Override enable for the Token field in this same CSR.
*/
#define NFP_ME_CmdIndirectRef1                               0x00000194
#define   NFP_ME_CmdIndirectRef1_Target(_x)                  (((_x) & 0xf) << 12)
#define   NFP_ME_CmdIndirectRef1_Target_of(_x)               (((_x) >> 12) & 0xf)
#define   NFP_ME_CmdIndirectRef1_Action(_x)                  (((_x) & 0x1f) << 7)
#define   NFP_ME_CmdIndirectRef1_Action_of(_x)               (((_x) >> 7) & 0x1f)
#define   NFP_ME_CmdIndirectRef1_Token(_x)                   (((_x) & 0x3) << 5)
#define   NFP_ME_CmdIndirectRef1_Token_of(_x)                (((_x) >> 5) & 0x3)
#define   NFP_ME_CmdIndirectRef1_OvTarget                    (1 << 2)
#define   NFP_ME_CmdIndirectRef1_OvAction                    (1 << 1)
#define   NFP_ME_CmdIndirectRef1_OvToken                     (1 << 0)
