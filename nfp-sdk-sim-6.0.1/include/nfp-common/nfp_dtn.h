...
int nfp_dtn_set_prop_u32(struct nfp_dtn *node, const char *prop_name, int values, uint32_t value_0, ...);

int nfp_dtn_set_prop_str(struct nfp_dtn *node, const char *prop_name, int values, const char *value_0, ...);
