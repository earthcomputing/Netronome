...
static nfp_inline unsigned int nfp6000_power_subdev_megrp(int iid, int megroup)
{
    switch (iid) {
    case 1:
        return NFP6000_DEVICE_ARM(iid - 1, NFP6000_DEVICE_ARM_MEG0 + megroup);
    case 4:
    case 5:
    case 6:
    case 7:
        return NFP6000_DEVICE_PCI(iid - 4, NFP6000_DEVICE_PCI_MEG0 + megroup);
    case 12:
    case 13:
        return NFP6000_DEVICE_CRP(iid - 12, NFP6000_DEVICE_CRP_MEG0 + megroup);
    case 32:
    case 33:
    case 34:
    case 35:
    ...
    case 37:
    case 38:
        return NFP6000_DEVICE_FPC(iid - 32, NFP6000_DEVICE_FPC_MEG0 + megroup);
    case 48:
    case 49:
        return NFP6000_DEVICE_ILA(iid - 48, NFP6000_DEVICE_ILA_MEG0 + megroup);
    default:
        break;
    }
