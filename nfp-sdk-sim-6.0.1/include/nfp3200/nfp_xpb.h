...
#define NFP_ME_CLUSTER_START(me)	NFP_XPB_DEST(me, 1)	/* Cluster Config */
#define NFP_ME_LSCRATCH_CSR_START(me)	NFP_XPB_DEST(me, 2)	/* Local scratch Config */
#define NFP_ME_LSCRATCH_ECC_START(me)	NFP_XPB_DEST(me, 3)	/* Local scratch ECC Monitor */

/* Crypto CSRs */
#define NFP_CRYPTO_CIF_START		NFP_XPB_DEST(19, 1)	/* CIF CSRs */
/* ... */

/* ARM CSRs */
/* ... */
#define NFP_ARM_INTR_START		NFP_XPB_DEST(20, 5)	/* Interrupt manager */
#define NFP_ARM_CFG_START		NFP_XPB_DEST(20, 6)	/* Local CSRs */
